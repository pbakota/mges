...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    _installSpecializedIsTest(object) {
      ...
      if (A.boolConversionCheck(J.$eq$(A.Rti__getKind(unstarred), 8)))
      ...
      } else if (A.boolConversionCheck(J.$eq$(A.Rti__getKind(unstarred), 11)))
    ...
    MapBase_mapToString(m) {
      ...
      try {
        J.add$1$a($.toStringVisiting, m);
        result.write$1("{");
        t1.first = true;
        m.forEach$1(0, new A.MapBase_mapToString_closure(t1, result));
        result.write$1("}");
      } finally {
        J.removeLast$0$a($.toStringVisiting);
      }
            ...
            if (count > 100) {
              while (true) {
                if (!($length > 75 && count > 3))
                  break;
                t1 = J.get$length$asx(B.JSArray_methods.removeLast$0(parts));
                if (typeof t1 !== "number")
                  return t1.$add();
                $length -= t1 + 2;
                --count;
    ...
    AudioElement_AudioElement$_(src) {
      if (src != null)
        return A.AudioElement__create_1(src);
      return A.AudioElement__create_2();
    },
    AudioElement__create_1(src) {
      var t1 = new Audio(src);
      t1.toString;
      return t1;
    },
    AudioElement__create_2() {
      var t1 = new Audio();
      t1.toString;
      return t1;
    },
    AudioElement_AudioElement() {
      return A.AudioElement_AudioElement$_(null);
    },
    ...
    ImageElement_ImageElement() {
      var t1 = A.document().createElement("img");
      t1.toString;
      return t1;
    },
    ...
    _convertDartToNative_Value(value) {
      ...
      if (type$.List_dynamic._is(value)) {
        array = [];
        B.JSArray_methods.forEach$1(value, new A._convertDartToNative_Value_closure(array));
        value = array;
      }
      return value;
    },
    ...
    AudioContext_decodeAudioData_success: function AudioContext_decodeAudioData_success(t0, t1) {
      this.completer = t0;
      this.successCallback = t1;
    },
    AudioContext_decodeAudioData_error: function AudioContext_decodeAudioData_error(t0, t1, t2, t3) {
      var _ = this;
      _._box_0 = t0;
      _.completer = t1;
      _.errorCallback = t2;
      _.nullErrorString = t3;
    },
    AudioContext_decodeAudioData_closure: function AudioContext_decodeAudioData_closure(t0, t1, t2) {
      this._box_0 = t0;
      this.errorCallback = t1;
      this.nullErrorString = t2;
    },
    AudioContext_decodeAudioData_closure0: function AudioContext_decodeAudioData_closure0() {
    },
    ...
    DrawTextOptions$(scale) {
      return new A.DrawTextOptions(false, "#00000000", scale == null ? 2 : scale);
    },
    BitmapText$(image) {
      var t1 = new A.BitmapText(A.JsLinkedHashMap$(type$.String, type$.ImageSlice));
      t1.BitmapText$1(image);
      return t1;
    },
    DrawTextOptions: function DrawTextOptions(t0, t1, t2) {
      this.shadow = t0;
      this.shadowColor = t1;
      this.scale = t2;
    },
    BitmapText: function BitmapText(t0) {
      this._glyphs = t0;
      this.__BitmapText__bufferCtx_A = this.__BitmapText__buffer_A = $;
    },
    MediaException$(cause) {
      return new A.MediaException();
    },
    Loader$() {
      return new A.Loader(A.JsLinkedHashMap$(type$.String, type$.Object));
    },
    Renderer$() {
      var t1 = new A.Renderer();
      t1.Renderer$0();
      return t1;
    },
    EngineOptions$(allowPause) {
      return new A.EngineOptions(allowPause === true);
    },
    Input$() {
      var t1 = new A.Input(A.JsLinkedHashMap$(type$.String, type$.bool));
      t1.Input$0();
      return t1;
    },
    Vector2$(x, y) {
      return new A.Vector2(x, y);
    },
    ImageSliceDrawOptions$(alpha, hflip, scale) {
      var t1 = scale == null ? 1 : scale,
        t2 = alpha == null ? 1 : alpha;
      return new A.ImageSliceDrawOptions(t1, false, hflip === true, t2);
    },
    ImageSlice$(img, x, y, w, h) {
      return new A.ImageSlice(x, y, w, h, img);
    },
    Util_formatNumber(number, places) {
      return J.substring$1$s(J.$add$ns(B.JSString_methods.$mul(" ", places), B.JSInt_methods.toString$0(number)), -places);
    },
    ImageCache$(canvas) {
      var t1 = new A.ImageCache(canvas);
      t1.ImageCache$1(canvas);
      return t1;
    },
    MediaException: function MediaException() {
    },
    Loader: function Loader(t0) {
      this._files = t0;
      this._fileCount = this._loadCount = 0;
    },
    Loader_load_closure: function Loader_load_closure(t0) {
      this.$this = t0;
    },
    Loader_load_closure0: function Loader_load_closure0(t0) {
      this.$this = t0;
    },
    Loader_load_closure1: function Loader_load_closure1(t0) {
      this.$this = t0;
    },
    Renderer: function Renderer() {
      var _ = this;
      _.__Renderer__bctx_A = _.__Renderer__ctx_A = _.__Renderer__bcanvas_A = _.__Renderer__canvas_A = $;
      _._scale = 1;
      _._scaleHeight = _._scaleWidth = 0;
    },
    EngineOptions: function EngineOptions(t0) {
      this.allowPause = t0;
    },
    ...
    Input: function Input(t0) {
      this._engine$_keys = t0;
    },
    Input_closure: function Input_closure(t0) {
      this.$this = t0;
    },
    Input_closure0: function Input_closure0(t0) {
      this.$this = t0;
    },
    Input__getKey_closure: function Input__getKey_closure(t0) {
      this.keyCode = t0;
    },
    Input__getKey_closure0: function Input__getKey_closure0() {
    },
    InputKey: function InputKey(t0, t1) {
      this.value = t0;
      this._core$_name = t1;
    },
    Vector2: function Vector2(t0, t1) {
      this.x = t0;
      this.y = t1;
    },
    ImageSliceDrawOptions: function ImageSliceDrawOptions(t0, t1, t2, t3) {
      var _ = this;
      _.scale = t0;
      _.vflip = t1;
      _.hflip = t2;
    ...
    ImageSlice: function ImageSlice(t0, t1, t2, t3, t4) {
      var _ = this;
      _.x = t0;
      _.y = t1;
      _.w = t2;
    ...
    ImageCache: function ImageCache(t0) {
      this.__ImageCache__backgroundCache_A = $;
      this._backbuffer = t0;
      this._cached = false;
    },
    Game$() {
      var t1 = A.Input$(),
        t2 = A.EngineOptions$(false),
        t3 = A.Renderer$(),
        t4 = A.Loader$();
      t1 = new A.Game(t1, B.GameScene_0, t3, t4, t2);
      t1.Engine$3(t2, null, null);
      t1.Game$0();
      return t1;
    },
    GameScene: function GameScene(t0) {
      this._core$_name = t0;
    },
    Game: function Game(t0, t1, t2, t3, t4) {
      ...
      _._renderer = t2;
      _._loader = t3;
      _._activated = _._paused = false;
      _._then = _._delta = _._now = 0;
      _._opts = t4;
      _._wasFullScreen = _._isFullScreen = false;
      _._frameId = null;
      _._gameLoaded = false;
    },
    HeroB$(game, position) {
      var t1 = type$.ImageElement;
      t1 = A._setArrayType([A.ImageSlice$(game.getAsset$1$1("hero1b", t1), 0, 0, 64, 64), A.ImageSlice$(game.getAsset$1$1("hero2b", t1), 0, 0, 64, 64)], type$.JSArray_ImageSlice);
      return new A.HeroB(t1, position);
    },
    HeroB: function HeroB(t0, t1) {
      var _ = this;
      _._hero$_frames = t0;
      _._hero$_animFrame = _._hero$_animTimer = 0;
      _.position = t1;
    },
    main() {
      var g = A.Game$();
      J.get$onBlur$x(A.window()).listen$1(new A.main_closure(g));
      J.get$onFocus$x(A.window()).listen$1(new A.main_closure0(g));
      g.run$0();
    },
    ...
    MobBee$(game, flipped, position, speed) {
      var t2,
        t1 = type$.ImageElement;
      t1 = A._setArrayType([A.ImageSlice$(game.getAsset$1$1("bee1a", t1), 0, 0, 16, 16), A.ImageSlice$(game.getAsset$1$1("bee2a", t1), 0, 0, 16, 16)], type$.JSArray_ImageSlice);
      A.createSentinel(type$.bool);
      t2 = type$.num;
      A.createSentinel(t2);
      A.createSentinel(type$.int);
      A.createSentinel(t2);
      t2 = A.Vector2$(0, 0);
      t2 = new A.MobBee(t1, speed, 20, flipped, t2, position);
      t2.Mob$6(flipped, t1, position, 2, speed, 20);
      return t2;
    },
    MobBlue$(game, flipped, position, speed) {
      var t2,
        t1 = type$.ImageElement;
      t1 = A._setArrayType([A.ImageSlice$(game.getAsset$1$1("blue1a", t1), 0, 0, 16, 16), A.ImageSlice$(game.getAsset$1$1("blue2a", t1), 0, 0, 16, 16)], type$.JSArray_ImageSlice);
      A.createSentinel(type$.bool);
      t2 = type$.num;
      A.createSentinel(t2);
      A.createSentinel(type$.int);
      A.createSentinel(t2);
      t2 = A.Vector2$(0, 0);
      t2 = new A.MobBlue(t1, speed, 50, flipped, t2, position);
      t2.Mob$6(flipped, t1, position, 3, speed, 50);
      return t2;
    },
    MobFoxy$(game, flipped, position, speed) {
      var t2,
        t1 = type$.ImageElement;
      t1 = A._setArrayType([A.ImageSlice$(game.getAsset$1$1("foxy1a", t1), 0, 0, 16, 16), A.ImageSlice$(game.getAsset$1$1("foxy2a", t1), 0, 0, 16, 16)], type$.JSArray_ImageSlice);
      A.createSentinel(type$.bool);
      t2 = type$.num;
      A.createSentinel(t2);
      A.createSentinel(type$.int);
      A.createSentinel(t2);
      t2 = A.Vector2$(0, 0);
      t2 = new A.MobFoxy(t1, speed, 100, flipped, t2, position);
      t2.Mob$6(flipped, t1, position, 2, speed, 100);
      return t2;
    },
    MobSniky$(game, flipped, position, speed) {
      var t2,
        t1 = type$.ImageElement;
      t1 = A._setArrayType([A.ImageSlice$(game.getAsset$1$1("sniky1a", t1), 0, 0, 16, 16), A.ImageSlice$(game.getAsset$1$1("sniky2a", t1), 0, 0, 16, 16)], type$.JSArray_ImageSlice);
      A.createSentinel(type$.bool);
      t2 = type$.num;
      A.createSentinel(t2);
      A.createSentinel(type$.int);
      A.createSentinel(t2);
      t2 = A.Vector2$(0, 0);
      t2 = new A.MobSniky(t1, speed, 200, flipped, t2, position);
      t2.Mob$6(flipped, t1, position, 2, speed, 200);
      return t2;
    },
    Mob: function Mob() {
    },
    MobBee: function MobBee(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _._frames = t0;
      _.__Mob__speed_A = t1;
      _.__Mob__points_A = t2;
      _._animFrame = _._animTimer = 0;
      _.flipped = t3;
      _.velocity = t4;
      _.position = t5;
    },
    MobBlue: function MobBlue(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _._frames = t0;
      _.__Mob__speed_A = t1;
      _.__Mob__points_A = t2;
    ...
    MobFoxy: function MobFoxy(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _._frames = t0;
      _.__Mob__speed_A = t1;
      _.__Mob__points_A = t2;
    ...
    MobSniky: function MobSniky(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _._frames = t0;
      _.__Mob__speed_A = t1;
      _.__Mob__points_A = t2;
    ...
    Medkit$(game, position) {
      var t1 = A.ImageSlice$(game.getAsset$1$1("medkit", type$.ImageElement), 0, 0, 16, 16),
        t2 = position == null ? A.Vector2$(0, 0) : position,
        t3 = A.Vector2$(0, 0);
      return new A.Medkit(t1, 500, false, t3, t2);
    },
    Bomb$(game, position) {
      var t1 = A.ImageSlice$(game.getAsset$1$1("bomb", type$.ImageElement), 0, 0, 16, 16),
        t2 = position == null ? A.Vector2$(0, 0) : position,
        t3 = A.Vector2$(0, 0);
      return new A.Bomb(t1, 500, false, t3, t2);
    },
    Powerup: function Powerup() {
    },
    Medkit: function Medkit(t0, t1, t2, t3, t4) {
      var _ = this;
      _._image = t0;
      _._points = t1;
      _.flipped = t2;
    ...
    Bomb: function Bomb(t0, t1, t2, t3, t4) {
      var _ = this;
      _._image = t0;
      _._points = t1;
      _.flipped = t2;
    ...
    Sound$(_src) {
      return new A.Sound(_src);
    },
    Music$(src) {
      var t1 = new A.Music(A.AudioElement_AudioElement());
      t1.Music$1(src);
      return t1;
    },
    ...
    Sound_load_closure: function Sound_load_closure(t0) {
      this.$this = t0;
    },
    Sound_load__closure: function Sound_load__closure(t0, t1) {
      this.$this = t0;
      this.request = t1;
    },
    Sound_load___closure: function Sound_load___closure(t0) {
      this.$this = t0;
    },
    Music: function Music(t0) {
      this._sound = t0;
    },
    ...
    TitleScene$(game) {
      var t1 = new A.TitleScene();
      t1.TitleScene$1(game);
      return t1;
    },
    TitleScene: function TitleScene() {
      var _ = this;
      _.__TitleScene__backgroundCache_A = _.__TitleScene__hero_A = _.__TitleScene__medkit_A = _.__TitleScene__bomb_A = _.__TitleScene__mobs_A = _.__TitleScene__text_A = _.__TitleScene__forest_A = _.__TitleScene__title_A = $;
    },
    TitleScene_draw_closure: function TitleScene_draw_closure(t0, t1) {
      this.$this = t0;
      this.ctx = t1;
    },
    TitleScene_draw_closure0: function TitleScene_draw_closure0(t0) {
      this.ctx = t0;
    },
    TitleScene_update_closure: function TitleScene_update_closure(t0) {
      this.dt = t0;
    },
  ...
  J = {
    ...
    set$font$x(receiver, value) {
      return J.getInterceptor$x(receiver).set$font(receiver, value);
    },
    set$globalCompositeOperation$x(receiver, value) {
      return J.getInterceptor$x(receiver).set$globalCompositeOperation(receiver, value);
    },
    set$height$x(receiver, value) {
      return J.getInterceptor$x(receiver).set$height(receiver, value);
    },
    set$imageSmoothingEnabled$x(receiver, value) {
      return J.getInterceptor$x(receiver).set$imageSmoothingEnabled(receiver, value);
    },
    set$loop$x(receiver, value) {
      return J.getInterceptor$x(receiver).set$loop(receiver, value);
    },
    set$textAlign$x(receiver, value) {
      return J.getInterceptor$x(receiver).set$textAlign(receiver, value);
    },
    set$textBaseline$x(receiver, value) {
      return J.getInterceptor$x(receiver).set$textBaseline(receiver, value);
    },
    set$title$x(receiver, value) {
      return J.getInterceptor$x(receiver).set$title(receiver, value);
    },
    set$width$x(receiver, value) {
      return J.getInterceptor$x(receiver).set$width(receiver, value);
    },
    set$x$z(receiver, value) {
      return J.getInterceptor$z(receiver).set$x(receiver, value);
    },
    get$_title$_title$x(receiver) {
      return J.getInterceptor$x(receiver).get$_title$_title(receiver);
    },
    get$body$x(receiver) {
      return J.getInterceptor$x(receiver).get$body(receiver);
    },
    get$context2D$x(receiver) {
      return J.getInterceptor$x(receiver).get$context2D(receiver);
    },
    get$hashCode$(receiver) {
      return J.getInterceptor$(receiver).get$hashCode(receiver);
    },
    get$height$x(receiver) {
      return J.getInterceptor$x(receiver).get$height(receiver);
    },
    get$innerHeight$x(receiver) {
      return J.getInterceptor$x(receiver).get$innerHeight(receiver);
    },
    get$innerWidth$x(receiver) {
      return J.getInterceptor$x(receiver).get$innerWidth(receiver);
    },
    ...
    get$onBlur$x(receiver) {
      return J.getInterceptor$x(receiver).get$onBlur(receiver);
    },
    get$onFocus$x(receiver) {
      return J.getInterceptor$x(receiver).get$onFocus(receiver);
    },
    get$points$z(receiver) {
      return J.getInterceptor$z(receiver).get$points(receiver);
    },
    get$response$x(receiver) {
    ...
    cancelAnimationFrame$1$x(receiver, a0) {
      return J.getInterceptor$x(receiver).cancelAnimationFrame$1(receiver, a0);
    },
    clear$0$z(receiver) {
      return J.getInterceptor$z(receiver).clear$0(receiver);
    },
    ...
    createElement$1$x(receiver, a0) {
      return J.getInterceptor$x(receiver).createElement$1(receiver, a0);
    },
    decodeAudioData$2$x(receiver, a0, a1) {
      return J.getInterceptor$x(receiver).decodeAudioData$2(receiver, a0, a1);
    },
    drawImageScaledFromSource$9$x(receiver, a0, a1, a2, a3, a4, a5, a6, a7, a8) {
      return J.getInterceptor$x(receiver).drawImageScaledFromSource$9(receiver, a0, a1, a2, a3, a4, a5, a6, a7, a8);
    },
    enterFullscreen$0$z(receiver) {
      return J.getInterceptor$z(receiver).enterFullscreen$0(receiver);
    },
    fillRect$4$x(receiver, a0, a1, a2, a3) {
      return J.getInterceptor$x(receiver).fillRect$4(receiver, a0, a1, a2, a3);
    },
    fillText$3$x(receiver, a0, a1, a2) {
      return J.getInterceptor$x(receiver).fillText$3(receiver, a0, a1, a2);
    },
    forEach$1$a(receiver, a0) {
      return J.getInterceptor$a(receiver).forEach$1(receiver, a0);
    },
    getBoundingClientRect$0$x(receiver) {
      return J.getInterceptor$x(receiver).getBoundingClientRect$0(receiver);
    },
    getContext$2$x(receiver, a0, a1) {
      return J.getInterceptor$x(receiver).getContext$2(receiver, a0, a1);
    },
    getElementById$1$x(receiver, a0) {
      return J.getInterceptor$x(receiver).getElementById$1(receiver, a0);
    },
    load$2$z(receiver, a0, a1) {
      return J.getInterceptor$z(receiver).load$2(receiver, a0, a1);
    },
    loop$1$x(receiver, a0) {
      return J.getInterceptor$x(receiver).loop$1(receiver, a0);
    },
    options$3$z(receiver, a0, a1, a2) {
      return J.getInterceptor$z(receiver).options$3(receiver, a0, a1, a2);
    },
    ...
    requestAnimationFrame$1$x(receiver, a0) {
  ...
  A.MapView.prototype = {
    ...
    forEach$1(_, action) {
      J.forEach$1$a(this._map, this.$ti._eval$1("~(1,2)")._as(action));
    },
    get$length(_) {
  ...
  A.CanvasElement.prototype = {
    ...
    set$height(receiver, value) {
      receiver.height = A._asIntQ(value);
    },
    get$width(receiver) {
      return receiver.width;
    },
    set$width(receiver, value) {
      receiver.width = A._asIntQ(value);
    },
    getContext$2(receiver, contextId, attributes) {
      A._asString(contextId);
      type$.nullable_Map_dynamic_dynamic._as(attributes);
      if (attributes != null)
        return this._getContext_1$2(receiver, contextId, A.convertDartToNative_Dictionary(attributes));
      return this._getContext_2$1(receiver, contextId);
    },
    _getContext_1$2(receiver, contextId, attributes) {
      return receiver.getContext(contextId, attributes);
    },
    _getContext_2$1(receiver, contextId) {
      return receiver.getContext(contextId);
    },
    get$context2D(receiver) {
      var t1 = receiver.getContext("2d");
      t1.toString;
      return t1;
    },
    $isCanvasElement: 1,
  ...
  A.CanvasRenderingContext2D.prototype = {
    ...
    set$font(receiver, value) {
      receiver.font = A._asString(value);
    },
    set$globalAlpha(receiver, value) {
      receiver.globalAlpha = A._asNum(value);
    },
    set$globalCompositeOperation(receiver, value) {
      receiver.globalCompositeOperation = A._asString(value);
    },
    set$imageSmoothingEnabled(receiver, value) {
      receiver.imageSmoothingEnabled = A._asBoolQ(value);
    },
    set$shadowBlur(receiver, value) {
      receiver.shadowBlur = A._asNum(value);
    },
    set$shadowColor(receiver, value) {
      receiver.shadowColor = A._asString(value);
    },
    set$shadowOffsetX(receiver, value) {
      receiver.shadowOffsetX = A._asNum(value);
    },
    set$shadowOffsetY(receiver, value) {
      receiver.shadowOffsetY = A._asNum(value);
    },
    set$textAlign(receiver, value) {
      receiver.textAlign = A._asString(value);
    },
    set$textBaseline(receiver, value) {
      receiver.textBaseline = A._asString(value);
    },
    clearRect$4(receiver, x, y, width, height) {
      return receiver.clearRect(A._asNum(x), A._asNum(y), A._asNum(width), A._asNum(height));
    },
    fillRect$4(receiver, x, y, width, height) {
      return receiver.fillRect(A._asNum(x), A._asNum(y), A._asNum(width), A._asNum(height));
    },
    restore$0(receiver) {
    ...
    scale$2(receiver, x, y) {
      return receiver.scale(A._asNum(x), A._asNum(y));
    },
    translate$2(receiver, x, y) {
      return receiver.translate(A._asNum(x), A._asNum(y));
    },
    drawImage$3(receiver, source, destX, destY) {
      return receiver.drawImage(type$.CanvasImageSource._as(source), A._asNum(destX), A._asNum(destY));
    },
    drawImageScaledFromSource$9(receiver, source, sourceX, sourceY, sourceWidth, sourceHeight, destX, destY, destWidth, destHeight) {
      return receiver.drawImage(type$.CanvasImageSource._as(source), A._asNum(sourceX), A._asNum(sourceY), A._asNum(sourceWidth), A._asNum(sourceHeight), A._asNum(destX), A._asNum(destY), A._asNum(destWidth), A._asNum(destHeight));
    },
    fillText$3(receiver, text, x, y) {
      receiver.fillText(A._asString(text), A._asNum(x), A._asNum(y));
    },
  ...
  A.Document.prototype = {
    set$_title(receiver, value) {
      receiver.title = A._asString(value);
    },
    getElementById$1(receiver, elementId) {
      return receiver.getElementById(A._asString(elementId));
    },
    createElement$1(receiver, tagName) {
      var t1 = this._createElement_2$1(receiver, A._asString(tagName));
      return type$.Element._as(t1);
    },
    _createElement_2$1(receiver, tagName) {
      return receiver.createElement(A._asString(tagName));
    },
    $isDocument: 1
  };
  ...
  A.DomRectReadOnly.prototype = {
    ...
    $eq(receiver, other) {
      ...
      if (other == null)
        return false;
      return type$.Rectangle_num._is(other) && A.boolConversionCheck(J.$eq$(_this.get$left(receiver), B._DomRect_methods.get$left(other))) && A.boolConversionCheck(J.$eq$(_this.get$top(receiver), B._DomRect_methods.get$top(other))) && A.boolConversionCheck(J.$eq$(_this.get$width(receiver), B._DomRect_methods.get$width(other))) && A.boolConversionCheck(J.$eq$(_this.get$height(receiver), B._DomRect_methods.get$height(other)));
    },
    get$hashCode(receiver) {
      var _this = this;
  ...
  A.Element.prototype = {
    ...
    getBoundingClientRect$0(receiver) {
      var t1 = receiver.getBoundingClientRect();
      t1.toString;
      return t1;
    },
    $isChildNode: 1,
  ...
  A.HtmlDocument.prototype = {
    ...
    set$title(receiver, value) {
      this.set$_title(receiver, A._asString(value));
    },
    $isHtmlDocument: 1
  };
  ...
  A.HttpRequest.prototype = {
    open$3$async(receiver, method, url, async) {
      return receiver.open(A._asString(method), A._asString(url), A._asBoolQ(async));
    },
  ...
  A.ImageElement.prototype = {
    set$src(receiver, value) {
      receiver.src = A._asStringQ(value);
    },
    $isImageElement: 1,
    $isCanvasImageSource: 1
  };
  ...
  A.MediaElement.prototype = {
    set$loop(receiver, value) {
      receiver.loop = A._asBool(value);
    },
    set$preload(receiver, value) {
      receiver.preload = A._asString(value);
    },
    set$src(receiver, value) {
      receiver.src = A._asString(value);
    },
    play$0(receiver) {
      var t1 = receiver.play();
      t1.toString;
  ...
  A.Node.prototype = {
    ...
    clone$1(receiver, deep) {
      var t1 = receiver.cloneNode(A._asBoolQ(deep));
      t1.toString;
      return t1;
    },
    $isNode: 1
  ...
  A.Window.prototype = {
    ...
    cancelAnimationFrame$1(receiver, id) {
      A._asInt(id);
      this._ensureRequestAnimationFrame$0(receiver);
    ...
    _cancelAnimationFrame$1(receiver, id) {
      return receiver.cancelAnimationFrame(A._asInt(id));
    },
    ...
    get$innerHeight(receiver) {
      return receiver.innerHeight;
    },
    get$innerWidth(receiver) {
      return receiver.innerWidth;
    },
    get$onBlur(receiver) {
      return B.EventStreamProvider_blur.forTarget$1(receiver);
    },
    get$onFocus(receiver) {
      return B.EventStreamProvider_focus.forTarget$1(receiver);
    },
    $isGlobalEventHandlers: 1,
    $isWindow: 1,
    $isWindowBase64: 1,
  ...
  A._DomRect.prototype = {
    ...
    $eq(receiver, other) {
      ...
      if (other == null)
        return false;
      return type$.Rectangle_num._is(other) && A.boolConversionCheck(J.$eq$(_this.get$left(receiver), _this.get$left(other))) && A.boolConversionCheck(J.$eq$(_this.get$top(receiver), _this.get$top(other))) && A.boolConversionCheck(J.$eq$(_this.get$width(receiver), _this.get$width(other))) && A.boolConversionCheck(J.$eq$(_this.get$height(receiver), _this.get$height(other)));
    },
    get$hashCode(receiver) {
      var _this = this;
      return A.Object_hash(_this.get$left(receiver), _this.get$top(receiver), _this.get$width(receiver), _this.get$height(receiver));
    ...
    findSlot$1(value) {
      ...
      for (i = 0; i < $length; ++i)
        if (A.boolConversionCheck(this.identicalInJs$2(t2.$index(t1, i), value)))
          return i;
      t2.add$1(t1, value);
      J.add$1$a(this.copies, null);
      return $length;
    },
    readSlot$1(i) {
      return J.$index$as(this.copies, A._asInt(i));
    },
    writeSlot$2(i, x) {
      J.$indexSet$a(this.copies, A._asInt(i), x);
    },
    walk$1(e) {
      var slot, copy, t1, map, $length, t2, i, _this = this;
      if (e == null)
        return e;
      if (A._isBool(e))
        return e;
      ...
      if (A.boolConversionCheck(A.isJavaScriptArray(e))) {
        ...
        for (t2 = copy && B.JSArray_methods, i = 0; i < $length; ++i) {
          if (!(i < t1.length))
            return A.ioore(t1, i);
          t2.$indexSet(copy, i, _this.walk$1(t1[i]));
        }
        return copy;
      }
      return e;
  ...
  A.AudioContext.prototype = {
    decodeAudioData$2(receiver, audioData, successCallback) {
      var completer, decodeResult,
        _s59_ = "[AudioContext.decodeAudioData] completed with a null error.",
        t1 = {};
      ...
      t1.errorInCallbackIsNull = false;
      decodeResult = successCallback == null ? receiver.decodeAudioData(audioData) : receiver.decodeAudioData(audioData, A.convertDartClosureToJS(new A.AudioContext_decodeAudioData_success(completer, successCallback), 1), A.convertDartClosureToJS(new A.AudioContext_decodeAudioData_error(t1, completer, null, _s59_), 1));
      if (decodeResult != null)
        return A.promiseToFuture(decodeResult, type$.AudioBuffer).catchError$1(new A.AudioContext_decodeAudioData_closure(t1, null, _s59_));
      return completer.get$future().then$1$1(new A.AudioContext_decodeAudioData_closure0(), type$.AudioBuffer);
    },
    $isAudioContext: 1
  };
  A.AudioContext_decodeAudioData_success.prototype = {
    call$1(decodedData) {
      type$.AudioBuffer._as(decodedData);
      J.complete$1$z(this.completer, decodedData);
      this.successCallback.call$1(decodedData);
    },
    $signature: 7
  };
  A.AudioContext_decodeAudioData_error.prototype = {
    call$1(error) {
      var t1, t2, _this = this;
      type$.nullable_DomException._as(error);
      t1 = _this.completer;
      t2 = J.getInterceptor$z(t1);
      if (error != null) {
        t2.complete$1(t1, error);
        _this.errorCallback.call$1(error);
      } else {
        t2.complete$1(t1, _this.nullErrorString);
        _this._box_0.errorInCallbackIsNull = true;
      }
    },
    $signature: 23
  };
  A.AudioContext_decodeAudioData_closure.prototype = {
    call$1(error) {
      var t1;
      if (A.boolConversionCheck(this._box_0.errorInCallbackIsNull))
        if (error != null) {
          t1 = this.errorCallback;
          if (t1 != null)
            t1.call$1(type$.DomException._as(error));
        } else
          throw A.wrapException(this.nullErrorString);
      throw A.wrapException(error == null ? type$.Object._as(error) : error);
    },
    $signature: 24
  };
  A.AudioContext_decodeAudioData_closure0.prototype = {
    call$1(value) {
      type$.Object._as(value);
      if (type$.AudioBuffer._is(value))
        return value;
  ...
  A.Actor.prototype = {};
  A.DrawTextOptions.prototype = {};
  A.BitmapText.prototype = {
    get$_buffer() {
      return this.__BitmapText__buffer_A;
    },
    set$_buffer(value) {
      this.__BitmapText__buffer_A = type$.CanvasElement._as(value);
    },
    get$_bufferCtx() {
      return this.__BitmapText__bufferCtx_A;
    },
    set$_bufferCtx(value) {
      this.__BitmapText__bufferCtx_A = type$.CanvasRenderingContext2D._as(value);
    },
    BitmapText$1(image) {
      var t1, t2, _this = this;
      _this.set$_buffer(type$.CanvasElement._as(J.createElement$1$x(A.document(), "canvas")));
      J.set$width$x(_this.get$_buffer(), 642);
      J.set$height$x(_this.get$_buffer(), 20);
      _this.set$_bufferCtx(J.get$context2D$x(_this.get$_buffer()));
      J.set$imageSmoothingEnabled$x(_this.get$_bufferCtx(), false);
      t1 = _this._glyphs;
      t2 = J.getInterceptor$a(t1);
      t2.$indexSet(t1, " ", A.ImageSlice$(image, 0, 0, 8, 8));
      t2.$indexSet(t1, "!", A.ImageSlice$(image, 8, 0, 8, 8));
      t2.$indexSet(t1, '"', A.ImageSlice$(image, 16, 0, 8, 8));
      t2.$indexSet(t1, "#", A.ImageSlice$(image, 24, 0, 8, 8));
      t2.$indexSet(t1, "$", A.ImageSlice$(image, 32, 0, 8, 8));
      t2.$indexSet(t1, "%", A.ImageSlice$(image, 40, 0, 8, 8));
      t2.$indexSet(t1, "&", A.ImageSlice$(image, 48, 0, 8, 8));
      t2.$indexSet(t1, "'", A.ImageSlice$(image, 56, 0, 8, 8));
      t2.$indexSet(t1, "(", A.ImageSlice$(image, 64, 0, 8, 8));
      t2.$indexSet(t1, ")", A.ImageSlice$(image, 72, 0, 8, 8));
      t2.$indexSet(t1, "*", A.ImageSlice$(image, 80, 0, 8, 8));
      t2.$indexSet(t1, "+", A.ImageSlice$(image, 88, 0, 8, 8));
      t2.$indexSet(t1, ",", A.ImageSlice$(image, 96, 0, 8, 8));
      t2.$indexSet(t1, "-", A.ImageSlice$(image, 104, 0, 8, 8));
      t2.$indexSet(t1, ".", A.ImageSlice$(image, 112, 0, 8, 8));
      t2.$indexSet(t1, "/", A.ImageSlice$(image, 120, 0, 8, 8));
      t2.$indexSet(t1, "0", A.ImageSlice$(image, 128, 0, 8, 8));
      t2.$indexSet(t1, "1", A.ImageSlice$(image, 136, 0, 8, 8));
      t2.$indexSet(t1, "2", A.ImageSlice$(image, 144, 0, 8, 8));
      t2.$indexSet(t1, "3", A.ImageSlice$(image, 152, 0, 8, 8));
      t2.$indexSet(t1, "4", A.ImageSlice$(image, 160, 0, 8, 8));
      t2.$indexSet(t1, "5", A.ImageSlice$(image, 168, 0, 8, 8));
      t2.$indexSet(t1, "6", A.ImageSlice$(image, 176, 0, 8, 8));
      t2.$indexSet(t1, "7", A.ImageSlice$(image, 184, 0, 8, 8));
      t2.$indexSet(t1, "8", A.ImageSlice$(image, 192, 0, 8, 8));
      t2.$indexSet(t1, "9", A.ImageSlice$(image, 200, 0, 8, 8));
      t2.$indexSet(t1, ":", A.ImageSlice$(image, 208, 0, 8, 8));
      t2.$indexSet(t1, ";", A.ImageSlice$(image, 216, 0, 8, 8));
      t2.$indexSet(t1, "<", A.ImageSlice$(image, 224, 0, 8, 8));
      t2.$indexSet(t1, "=", A.ImageSlice$(image, 232, 0, 8, 8));
      t2.$indexSet(t1, ">", A.ImageSlice$(image, 240, 0, 8, 8));
      t2.$indexSet(t1, "?", A.ImageSlice$(image, 248, 0, 8, 8));
      t2.$indexSet(t1, "@", A.ImageSlice$(image, 0, 8, 8, 8));
      t2.$indexSet(t1, "A", A.ImageSlice$(image, 8, 8, 8, 8));
      t2.$indexSet(t1, "B", A.ImageSlice$(image, 16, 8, 8, 8));
      t2.$indexSet(t1, "C", A.ImageSlice$(image, 24, 8, 8, 8));
      t2.$indexSet(t1, "D", A.ImageSlice$(image, 32, 8, 8, 8));
      t2.$indexSet(t1, "E", A.ImageSlice$(image, 40, 8, 8, 8));
      t2.$indexSet(t1, "F", A.ImageSlice$(image, 48, 8, 8, 8));
      t2.$indexSet(t1, "G", A.ImageSlice$(image, 56, 8, 8, 8));
      t2.$indexSet(t1, "H", A.ImageSlice$(image, 64, 8, 8, 8));
      t2.$indexSet(t1, "I", A.ImageSlice$(image, 72, 8, 8, 8));
      t2.$indexSet(t1, "J", A.ImageSlice$(image, 80, 8, 8, 8));
      t2.$indexSet(t1, "K", A.ImageSlice$(image, 88, 8, 8, 8));
      t2.$indexSet(t1, "L", A.ImageSlice$(image, 96, 8, 8, 8));
      t2.$indexSet(t1, "M", A.ImageSlice$(image, 104, 8, 8, 8));
      t2.$indexSet(t1, "N", A.ImageSlice$(image, 112, 8, 8, 8));
      t2.$indexSet(t1, "O", A.ImageSlice$(image, 120, 8, 8, 8));
      t2.$indexSet(t1, "P", A.ImageSlice$(image, 128, 8, 8, 8));
      t2.$indexSet(t1, "Q", A.ImageSlice$(image, 136, 8, 8, 8));
      t2.$indexSet(t1, "R", A.ImageSlice$(image, 144, 8, 8, 8));
      t2.$indexSet(t1, "S", A.ImageSlice$(image, 152, 8, 8, 8));
      t2.$indexSet(t1, "T", A.ImageSlice$(image, 160, 8, 8, 8));
      t2.$indexSet(t1, "U", A.ImageSlice$(image, 168, 8, 8, 8));
      t2.$indexSet(t1, "V", A.ImageSlice$(image, 176, 8, 8, 8));
      t2.$indexSet(t1, "W", A.ImageSlice$(image, 184, 8, 8, 8));
      t2.$indexSet(t1, "X", A.ImageSlice$(image, 192, 8, 8, 8));
      t2.$indexSet(t1, "Y", A.ImageSlice$(image, 200, 8, 8, 8));
      t2.$indexSet(t1, "Z", A.ImageSlice$(image, 208, 8, 8, 8));
      t2.$indexSet(t1, "[", A.ImageSlice$(image, 216, 8, 8, 8));
      t2.$indexSet(t1, "|", A.ImageSlice$(image, 224, 8, 8, 8));
      t2.$indexSet(t1, "]", A.ImageSlice$(image, 232, 8, 8, 8));
      t2.$indexSet(t1, "{", A.ImageSlice$(image, 240, 8, 8, 8));
      t2.$indexSet(t1, "}", A.ImageSlice$(image, 248, 8, 8, 8));
      t2.$indexSet(t1, "a", A.ImageSlice$(image, 0, 16, 8, 8));
      t2.$indexSet(t1, "b", A.ImageSlice$(image, 8, 16, 8, 8));
      t2.$indexSet(t1, "c", A.ImageSlice$(image, 16, 16, 8, 8));
      t2.$indexSet(t1, "d", A.ImageSlice$(image, 24, 16, 8, 8));
      t2.$indexSet(t1, "e", A.ImageSlice$(image, 32, 16, 8, 8));
      t2.$indexSet(t1, "f", A.ImageSlice$(image, 40, 16, 8, 8));
      t2.$indexSet(t1, "g", A.ImageSlice$(image, 48, 16, 8, 8));
      t2.$indexSet(t1, "h", A.ImageSlice$(image, 56, 16, 8, 8));
      t2.$indexSet(t1, "i", A.ImageSlice$(image, 64, 16, 8, 8));
      t2.$indexSet(t1, "j", A.ImageSlice$(image, 72, 16, 8, 8));
      t2.$indexSet(t1, "k", A.ImageSlice$(image, 80, 16, 8, 8));
      t2.$indexSet(t1, "l", A.ImageSlice$(image, 88, 16, 8, 8));
      t2.$indexSet(t1, "m", A.ImageSlice$(image, 96, 16, 8, 8));
      t2.$indexSet(t1, "n", A.ImageSlice$(image, 104, 16, 8, 8));
      t2.$indexSet(t1, "o", A.ImageSlice$(image, 112, 16, 8, 8));
      t2.$indexSet(t1, "p", A.ImageSlice$(image, 120, 16, 8, 8));
      t2.$indexSet(t1, "q", A.ImageSlice$(image, 128, 16, 8, 8));
      t2.$indexSet(t1, "r", A.ImageSlice$(image, 136, 16, 8, 8));
      t2.$indexSet(t1, "s", A.ImageSlice$(image, 144, 16, 8, 8));
      t2.$indexSet(t1, "t", A.ImageSlice$(image, 152, 16, 8, 8));
      t2.$indexSet(t1, "u", A.ImageSlice$(image, 160, 16, 8, 8));
      t2.$indexSet(t1, "v", A.ImageSlice$(image, 168, 16, 8, 8));
      t2.$indexSet(t1, "w", A.ImageSlice$(image, 176, 16, 8, 8));
      t2.$indexSet(t1, "x", A.ImageSlice$(image, 184, 16, 8, 8));
      t2.$indexSet(t1, "y", A.ImageSlice$(image, 192, 16, 8, 8));
      t2.$indexSet(t1, "z", A.ImageSlice$(image, 200, 16, 8, 8));
    },
    draw$6(ctx, x, y, color, text, options) {
      var opts, t1, t2, t3, t4, xx, c, t5, _this = this;
      type$.CanvasRenderingContext2D._as(ctx);
      A._asInt(x);
      A._asInt(y);
      A._asString(color);
      A._asString(text);
      type$.nullable_DrawTextOptions._as(options);
      opts = options == null ? A.DrawTextOptions$(null) : options;
      J.save$0$x(_this.get$_bufferCtx());
      t1 = _this.get$_bufferCtx();
      t2 = J.get$width$x(_this.get$_buffer());
      t2.toString;
      t3 = J.get$height$x(_this.get$_buffer());
      t3.toString;
      J.clearRect$4$x(t1, x, y, t2, t3);
      for (t1 = text.length, t2 = opts.scale, t3 = _this._glyphs, t4 = J.getInterceptor$as(t3), xx = 0, c = 0; c < t1; ++c) {
        t5 = t4.$index(t3, text[c]);
        if (t5 != null)
          t5.draw$4$options(_this.get$_bufferCtx(), xx, 0, A.ImageSliceDrawOptions$(null, null, t2));
        if (typeof t2 !== "number")
          return A.iae(t2);
        t5 = B.JSNumber_methods.toInt$0(8 * t2);
        if (typeof t5 !== "number")
          return A.iae(t5);
        xx += t5;
      }
      J.set$fillStyle$x(_this.get$_bufferCtx(), color);
      J.set$globalCompositeOperation$x(_this.get$_bufferCtx(), "source-in");
      t3 = _this.get$_bufferCtx();
      if (typeof t2 !== "number")
        return A.iae(t2);
      J.fillRect$4$x(t3, 0, 0, t1 * 8 * t2, 8 * t2);
      J.restore$0$x(_this.get$_bufferCtx());
      if (A.boolConversionCheck(opts.shadow)) {
        B.CanvasRenderingContext2D_methods.save$0(ctx);
        B.CanvasRenderingContext2D_methods.set$shadowOffsetX(ctx, 1);
        B.CanvasRenderingContext2D_methods.set$shadowOffsetY(ctx, 1);
        B.CanvasRenderingContext2D_methods.set$shadowColor(ctx, opts.shadowColor);
        B.CanvasRenderingContext2D_methods.set$shadowBlur(ctx, 0);
        B.CanvasRenderingContext2D_methods.drawImage$3(ctx, _this.get$_buffer(), x, y);
        B.CanvasRenderingContext2D_methods.restore$0(ctx);
      } else
        B.CanvasRenderingContext2D_methods.drawImage$3(ctx, _this.get$_buffer(), x, y);
    },
    draw$5(ctx, x, y, color, text) {
      return this.draw$6(ctx, x, y, color, text, null);
    }
  };
  A.MediaException.prototype = {$isException: 1};
  A.Loader.prototype = {
    $get$1$1($name, $T) {
      return $T._as(J.$index$as(this._files, A._asString($name)));
    },
    progress$0() {
      var t1, t2;
      if (A.boolConversionCheck(J.$eq$(this._fileCount, 0)))
        t1 = 1;
      else {
        t1 = this._loadCount;
        t2 = this._fileCount;
        ...
        if (typeof t2 !== "number")
          return A.iae(t2);
        t2 = B.JSNumber_methods.$tdiv(t1, t2);
        t1 = t2;
      }
      return t1;
    },
    load$2(_, $name, src) {
      var t1, img, audio, sound, _this = this;
      A._asString($name);
      A._asString(src);
      t1 = _this._fileCount;
      if (typeof t1 !== "number")
        return t1.$add();
      _this.set$_fileCount(t1 + 1);
      t1 = A._setArrayType(src.split("."), type$.JSArray_String);
      if (0 >= t1.length)
        return A.ioore(t1, 0);
      switch (t1[0]) {
        case "png":
          img = A.ImageElement_ImageElement();
          J.$indexSet$a(_this._files, $name, img);
          B.ImageElement_methods.addEventListener$2(img, "load", new A.Loader_load_closure(_this));
          B.ImageElement_methods.set$src(img, src);
          break;
        case "ogg":
          audio = A.Music$(src);
          J.$indexSet$a(_this._files, $name, audio);
          audio.addEventListener$2(0, "loadeddata", new A.Loader_load_closure0(_this));
          break;
        case "wav":
          sound = A.Sound$(src);
          J.$indexSet$a(_this._files, $name, sound);
          sound.load$0(0).then$1$1(new A.Loader_load_closure1(_this), type$.int);
          break;
        default:
          throw A.wrapException(A.MediaException$("Unsupported media format!"));
      }
    },
    set$_loadCount(_loadCount) {
      this._loadCount = A._asInt(_loadCount);
    },
    set$_fileCount(_fileCount) {
      this._fileCount = A._asInt(_fileCount);
    }
  };
  A.Loader_load_closure.prototype = {
    call$1($event) {
      var t1, t2;
      ...
      if (typeof t2 !== "number")
        return t2.$add();
      t1.set$_loadCount(t2 + 1);
      return t2;
    },
    $signature: 8
  };
  A.Loader_load_closure0.prototype = {
    call$1($event) {
      var t1, t2;
      type$.Event._as($event);
      t1 = this.$this;
  ...
  A.Loader_load_closure1.prototype = {
    call$1(result) {
      var t1 = this.$this,
        t2 = t1._loadCount;
      if (typeof t2 !== "number")
  ...
  A.Renderer.prototype = {
    get$_canvas() {
      return this.__Renderer__canvas_A;
    },
    set$_canvas(value) {
      this.__Renderer__canvas_A = type$.CanvasElement._as(value);
    },
    get$_bcanvas() {
      return this.__Renderer__bcanvas_A;
    },
    set$_bcanvas(value) {
      this.__Renderer__bcanvas_A = type$.CanvasElement._as(value);
    },
    get$_ctx() {
      return this.__Renderer__ctx_A;
    },
    set$_ctx(value) {
      this.__Renderer__ctx_A = type$.CanvasRenderingContext2D._as(value);
    },
    get$_bctx() {
      return this.__Renderer__bctx_A;
    },
    set$_bctx(value) {
      this.__Renderer__bctx_A = type$.CanvasRenderingContext2D._as(value);
    },
    Renderer$0() {
      var _this = this,
        t1 = type$.CanvasElement;
      _this.set$_canvas(t1._as(J.getElementById$1$x(A.document(), "canvas")));
      _this.set$_ctx(J.get$context2D$x(_this.get$_canvas()));
      _this.set$_bcanvas(t1._as(J.createElement$1$x(A.document(), "canvas")));
      _this.set$_bctx(J.get$context2D$x(_this.get$_bcanvas()));
    },
    get$width(_) {
      var t1 = J.get$width$x(this.get$_bcanvas());
      t1.toString;
      return t1;
    },
    get$height(_) {
      var t1 = J.get$height$x(this.get$_bcanvas());
      t1.toString;
      return t1;
    },
    get$ctx() {
      return this.get$_bctx();
    },
    get$backbuffer() {
      return this.get$_bcanvas();
    },
    get$display(_) {
    ...
    flip$0() {
      var t4, _this = this,
        t1 = _this.get$_ctx(),
        t2 = _this.get$_bcanvas(),
        t3 = J.get$width$x(_this.get$_bcanvas());
      t3.toString;
      t4 = J.get$height$x(_this.get$_bcanvas());
      t4.toString;
      J.drawImageScaledFromSource$9$x(t1, t2, 0, 0, t3, t4, 0, 0, _this._scaleWidth, _this._scaleHeight);
    },
    clear$0(_) {
      var t1, t2, t3, _this = this;
      J.set$fillStyle$x(_this.get$_bctx(), "#00000000");
      t1 = _this.get$_bctx();
      t2 = J.get$width$x(_this.get$_bcanvas());
      t2.toString;
      t3 = J.get$height$x(_this.get$_bcanvas());
      t3.toString;
      J.clearRect$4$x(t1, 0, 0, t2, t3);
    },
    resize$3(newWidth, newHeight, scale) {
      var t1, t2, _this = this;
      A._asInt(newWidth);
      A._asInt(newHeight);
      A._asNum(scale);
      t1 = J.get$width$x(_this.get$_canvas());
      t1.toString;
      t2 = J.get$height$x(_this.get$_canvas());
      t2.toString;
      if (typeof t1 !== "number")
        return t1.$div();
      if (typeof t2 !== "number")
        return A.iae(t2);
      _this._scale = scale;
      _this.set$_scaleWidth(B.JSNumber_methods.toInt$0(newHeight * (t1 / t2)));
      _this.set$_scaleHeight(B.JSInt_methods.toInt$0(newHeight));
      J.set$width$x(_this.get$_canvas(), _this._scaleWidth);
      J.set$height$x(_this.get$_canvas(), _this._scaleHeight);
    },
    options$3(_, width, height, scale) {
      var t1, _this = this;
      A._asInt(width);
      A._asInt(height);
      A._asNum(scale);
      _this._scale = scale;
      _this.set$_scaleWidth(B.JSNumber_methods.toInt$0(scale * width));
      t1 = _this._scale;
      if (typeof t1 !== "number")
        return t1.$mul();
      _this.set$_scaleHeight(B.JSNumber_methods.toInt$0(t1 * height));
      J.set$width$x(_this.get$_canvas(), _this._scaleWidth);
      J.set$height$x(_this.get$_canvas(), _this._scaleHeight);
      J.set$width$x(_this.get$_bcanvas(), width);
      J.set$height$x(_this.get$_bcanvas(), height);
      J.set$imageSmoothingEnabled$x(_this.get$_bctx(), false);
      J.set$imageSmoothingEnabled$x(_this.get$_ctx(), false);
    },
    set$_scaleWidth(_scaleWidth) {
      this._scaleWidth = A._asInt(_scaleWidth);
    },
    set$_scaleHeight(_scaleHeight) {
      this._scaleHeight = A._asInt(_scaleHeight);
    }
  };
  A.EngineOptions.prototype = {};
  A.Engine.prototype = {
    Engine$3(options, renderer, loader) {
      A.Future_Future$delayed(B.Duration_1000000, new A.Engine_closure(this), type$.Null);
    },
    get$renderer() {
    ...
    updateDelta$1(timestamp) {
      var t1, _this = this;
      A._asNum(timestamp);
      _this._now = timestamp;
      t1 = _this._then;
      if (typeof t1 !== "number")
        return A.iae(t1);
      t1 = (timestamp - t1) / 1000;
      _this._delta = t1;
      if (t1 > 1)
        _this._delta = 1;
      _this._then = timestamp;
    },
    loop$1(_, timestamp) {
      var t1, _this = this;
      A._asNum(timestamp);
      _this.set$_frameId(J.requestAnimationFrame$1$x(A.window(), _this.get$loop(_this)));
      _this.updateDelta$1(timestamp);
      if (A.boolConversionCheck(_this._gameLoaded)) {
        _this.set$_gameLoaded(J.$eq$(_this._loader.progress$0(), 1));
        if (A.boolConversionCheck(_this._gameLoaded))
          _this.ready$0();
        return;
      }
      _this.update$1(J.toDouble$0$n(_this._delta));
      t1 = _this._renderer;
      J.clear$0$z(t1);
      _this.draw$1(t1.get$ctx());
      t1.flip$0();
    },
    run$0() {
      var t1, t2, t3, t4;
      if (A.boolConversionCheck(this._activated))
        return;
      t1 = this._renderer;
      t2 = J.getInterceptor$z(t1);
      J.addEventListener$2$x(t2.get$display(t1), "click", new A.Engine_run_closure(this));
      t2.clear$0(t1);
      J.set$fillStyle$x(t1.get$ctx(), "blue");
      J.set$font$x(t1.get$ctx(), "bold 16px Arial");
      J.set$textAlign$x(t1.get$ctx(), "center");
      J.set$textBaseline$x(t1.get$ctx(), "middle");
      t3 = t1.get$ctx();
      t4 = t2.get$width(t1);
      if (typeof t4 !== "number")
        return t4.$div();
      ...
      if (typeof t2 !== "number")
        return t2.$div();
      J.fillText$3$x(t3, "Click to start the game!", t4 / 2, t2 / 2);
      t1.flip$0();
    },
    stop$0(_) {
      var t1, t2, _this = this;
      if (!A.boolConversionCheck(_this._opts.allowPause))
        return;
      ...
      t2 = _this._frameId;
      t2.toString;
      J.cancelAnimationFrame$1$x(t1, t2);
      _this.pause$0(0);
    },
    restart$0() {
      var _this = this;
      if (!A.boolConversionCheck(_this._opts.allowPause))
        return;
      if (!A.boolConversionCheck(_this._paused))
        return;
      _this._paused = false;
    ...
    setWindowTitle$1(title) {
      A._asString(title);
      J.set$title$x(A.document(), title);
    },
    set$_frameId(_frameId) {
      this._frameId = A._asIntQ(_frameId);
    },
    set$_gameLoaded(_gameLoaded) {
      this._gameLoaded = A._asBool(_gameLoaded);
    }
  };
  A.Engine_closure.prototype = {
    call$0() {
      var t1 = this.$this,
        t2 = J.getElementById$1$x(A.document(), "detector");
      t2.toString;
      t2 = J.get$top$x(J.getBoundingClientRect$0$x(t2));
      if (typeof t2 !== "number")
        return t2.$gt();
      t2 = t2 > 0;
      t1._isFullScreen = t2;
      t1.toString;
      if (t2) {
        if (!A.boolConversionCheck(t1._wasFullScreen)) {
          t1._wasFullScreen = true;
          J.enterFullscreen$0$z(t1);
        }
      } else if (A.boolConversionCheck(t1._wasFullScreen)) {
        t1._wasFullScreen = false;
        t1.leaveFullscreen$0();
      }
    },
    $signature: 1
  };
  A.Engine_run_closure.prototype = {
    call$1(e) {
      var t1;
      J.preventDefault$0$x(type$.Event._as(e));
      t1 = this.$this;
      t1._activated = true;
      t1.init$0();
      J.loop$1$x(t1, 0);
  ...
  A.Input.prototype = {
    Input$0() {
      J.addEventListener$2$x(A.window(), "keydown", new A.Input_closure(this));
      J.addEventListener$2$x(A.window(), "keyup", new A.Input_closure0(this));
    },
    _getKey$1(keyCode) {
      return B.JSArray_methods.singleWhere$2$orElse(B.List_Rof, new A.Input__getKey_closure(A._asString(keyCode)), new A.Input__getKey_closure0());
    },
    isPressed$1(keyCode) {
      var t1 = this._engine$_keys,
        t2 = type$.InputKey._as(keyCode).value,
        t3 = J.getInterceptor$as(t1),
        pressed = J.$eq$(t3.$index(t1, B.JSString_methods.$add("k", t2)), true);
      t3.$indexSet(t1, B.JSString_methods.$add("k", t2), false);
      return pressed;
    },
    set$_lastKey(_lastKey) {
      type$.InputKey._as(_lastKey);
    }
  };
  A.Input_closure.prototype = {
    call$1($event) {
      var t1, t2, t3;
      $event = type$.KeyboardEvent._as(type$.Event._as($event));
      t1 = this.$this;
      t2 = t1._engine$_keys;
      t3 = B.KeyboardEvent_methods.get$code($event);
      t3.toString;
      J.$indexSet$a(t2, B.JSString_methods.$add("k", t3), true);
      t3 = B.KeyboardEvent_methods.get$code($event);
      t3.toString;
      t1.set$_lastKey(t1._getKey$1(t3));
    },
    $signature: 4
  };
  A.Input_closure0.prototype = {
    call$1($event) {
      var t1, t2;
      $event = type$.KeyboardEvent._as(type$.Event._as($event));
      t1 = this.$this._engine$_keys;
      t2 = B.KeyboardEvent_methods.get$code($event);
      t2.toString;
      J.$indexSet$a(t1, B.JSString_methods.$add("k", t2), false);
    },
    $signature: 4
  };
  A.Input__getKey_closure.prototype = {
    call$1(element) {
      return type$.InputKey._as(element) === this.keyCode;
    },
    $signature: 28
  };
  A.Input__getKey_closure0.prototype = {
    call$0() {
      return B.InputKey_FNF;
    },
    $signature: 29
  };
  A.InputKey.prototype = {
    _enumToString$0() {
      return "InputKey." + A.S(this._core$_name);
    }
  };
  A.Vector2.prototype = {
    set$x(_, x) {
  ...
  A.ImageSliceDrawOptions.prototype = {};
  A.ImageSlice.prototype = {
    draw$4$options(ctx, x, y, options) {
      var opts, t1, t2, t3, t4, xx, yy, _this = this;
      type$.CanvasRenderingContext2D._as(ctx);
      A._asNum(x);
      A._asNum(y);
      type$.nullable_ImageSliceDrawOptions._as(options);
      opts = options == null ? A.ImageSliceDrawOptions$(null, null, null) : options;
      B.CanvasRenderingContext2D_methods.save$0(ctx);
      t1 = A.boolConversionCheck(opts.hflip);
      if (t1 || A.boolConversionCheck(opts.vflip)) {
        if (t1) {
          t2 = _this.w;
          if (typeof t2 !== "number")
            return A.iae(t2);
          ...
          t2 = 0;
        t3 = A.boolConversionCheck(opts.vflip);
        if (t3) {
          t4 = _this.h;
          if (typeof t4 !== "number")
            return A.iae(t4);
          ...
          t4 = 0;
        B.CanvasRenderingContext2D_methods.translate$2(ctx, t2, t4);
        B.CanvasRenderingContext2D_methods.scale$2(ctx, -1, 1);
        xx = t1 ? 0 : x;
        yy = t3 ? 0 : y;
      } else {
        yy = y;
      ...
      B.CanvasRenderingContext2D_methods.set$globalAlpha(ctx, opts.alpha);
      t1 = _this.w;
      t2 = _this.h;
      t3 = opts.scale;
      if (typeof t1 !== "number")
      ...
      if (typeof t3 !== "number")
        return A.iae(t3);
      t4 = B.JSNumber_methods.toInt$0(t1 * t3);
      if (typeof t2 !== "number")
        return t2.$mul();
      B.CanvasRenderingContext2D_methods.drawImageScaledFromSource$9(ctx, _this._img, _this.x, _this.y, t1, t2, xx, yy, t4, B.JSNumber_methods.toInt$0(t2 * t3));
      B.CanvasRenderingContext2D_methods.restore$0(ctx);
    },
    draw$3(ctx, x, y) {
      return this.draw$4$options(ctx, x, y, null);
    }
  };
  A.ImageCache.prototype = {
    get$_engine$_backgroundCache() {
      return this.__ImageCache__backgroundCache_A;
    },
    set$_engine$_backgroundCache(value) {
      this.__ImageCache__backgroundCache_A = type$.CanvasElement._as(value);
    },
    ImageCache$1(canvas) {
      this.set$_engine$_backgroundCache(type$.CanvasElement._as(B.CanvasElement_methods.clone$1(canvas, true)));
    },
    draw$2(ctx, render) {
      var t2, _this = this,
        t1 = type$.CanvasRenderingContext2D;
      t1._as(ctx);
      type$.void_Function._as(render);
      if (A.boolConversionCheck(_this._cached))
        B.CanvasRenderingContext2D_methods.drawImage$3(ctx, _this.get$_engine$_backgroundCache(), 0, 0);
      else {
        render.call$0();
        t2 = type$.dynamic;
        B.CanvasRenderingContext2D_methods.drawImage$3(t1._as(J.getContext$2$x(_this.get$_engine$_backgroundCache(), "2d", A.LinkedHashMap_LinkedHashMap$_literal(["alpha", false], t2, t2))), _this._backbuffer, 0, 0);
        _this._cached = true;
      }
    }
  };
  A.GameScene.prototype = {
    _enumToString$0() {
      return "GameScene." + A.S(this._core$_name);
    }
  };
  A.Game.prototype = {
    get$_music() {
      return this.__Game__music_A;
    },
    set$_music(value) {
      this.__Game__music_A = type$.Music._as(value);
    },
    Game$0() {
      var t1 = this.get$renderer(),
        t2 = $.$get$displaySize();
      J.options$3$z(t1, J.toInt$0$n(t2.x), J.toInt$0$n(t2.y), 1.8);
    },
    enterFullscreen$0(_) {
      var t1, t2, t3;
      A.print("Entering fullscreen");
      t1 = this.get$renderer();
      t2 = J.get$innerWidth$x(A.window());
      t2.toString;
      t3 = J.get$innerHeight$x(A.window());
      t3.toString;
      t1.resize$3(t2, t3, 1.8);
    },
    leaveFullscreen$0() {
      var t1, t2;
      A.print("Leaving fullscreen");
      t1 = this.get$renderer();
      t2 = $.$get$displaySize();
      J.options$3$z(t1, J.toInt$0$n(t2.x), J.toInt$0$n(t2.y), 1.8);
    },
    ...
    init$0() {
      var _this = this,
        _s9_ = "explosion",
        _s30_ = "assets/Sprites/explosion-4.png";
      A.print("loading game assets ...");
      J.load$2$z(_this.get$loader(), "forest", "assets/Bitmaps/background.png");
      J.load$2$z(_this.get$loader(), "titleBitmap", "assets/Bitmaps/title.png");
      J.load$2$z(_this.get$loader(), "elements", "assets/Bitmaps/elements.png");
      J.load$2$z(_this.get$loader(), "bitmapFont", "assets/Fonts/font.png");
      J.load$2$z(_this.get$loader(), "bee1a", "assets/Sprites/bee1a.png");
      J.load$2$z(_this.get$loader(), "bee2a", "assets/Sprites/bee2a.png");
      J.load$2$z(_this.get$loader(), "blue1a", "assets/Sprites/blue1a.png");
      J.load$2$z(_this.get$loader(), "blue2a", "assets/Sprites/blue2a.png");
      J.load$2$z(_this.get$loader(), "sniky1a", "assets/Sprites/sniky1.png");
      J.load$2$z(_this.get$loader(), "sniky2a", "assets/Sprites/sniky2.png");
      J.load$2$z(_this.get$loader(), "foxy1a", "assets/Sprites/roka1.png");
      J.load$2$z(_this.get$loader(), "foxy2a", "assets/Sprites/roka2.png");
      J.load$2$z(_this.get$loader(), "hero1a", "assets/Sprites/hero1.png");
      J.load$2$z(_this.get$loader(), "hero2a", "assets/Sprites/hero2.png");
      J.load$2$z(_this.get$loader(), "hero1b", "assets/Sprites/hero1b.png");
      J.load$2$z(_this.get$loader(), "hero2b", "assets/Sprites/hero2b.png");
      J.load$2$z(_this.get$loader(), "bomb", "assets/Sprites/bombball.png");
      J.load$2$z(_this.get$loader(), "medkit", "assets/Sprites/medkit.png");
      J.load$2$z(_this.get$loader(), _s9_, _s30_);
      J.load$2$z(_this.get$loader(), "bullet", "assets/Sprites/bullet.png");
      J.load$2$z(_this.get$loader(), "blood-ground", "assets/Sprites/blood_tile.png");
      J.load$2$z(_this.get$loader(), "blood-particle", "assets/Sprites/blood.png");
      J.load$2$z(_this.get$loader(), "world-1", "assets/Sounds/world_1.ogg");
      J.load$2$z(_this.get$loader(), "energybar", "assets/Sprites/healthbar.png");
      J.load$2$z(_this.get$loader(), "ground", "assets/Sprites/tile_0004.png");
      J.load$2$z(_this.get$loader(), _s9_, _s30_);
      J.load$2$z(_this.get$loader(), "explosion_long-fx", "assets/Sounds/explosion_long.wav");
      J.load$2$z(_this.get$loader(), "explosion-fx", "assets/Sounds/explosion.wav");
      J.load$2$z(_this.get$loader(), "fire-fx", "assets/Sounds/fire.wav");
      J.load$2$z(_this.get$loader(), "hit-fx", "assets/Sounds/hit.wav");
      J.load$2$z(_this.get$loader(), "pickup-fx", "assets/Sounds/pickup.wav");
      J.load$2$z(_this.get$loader(), "tick-fx", "assets/Sounds/tick.wav");
    },
    getAsset$1$1($name, $T) {
      A._asString($name);
      return this.get$loader().$get$1$1($name, $T);
    },
    ready$0() {
      var t1, _this = this;
      A.print("game ready ...");
      _this.set$_music(_this.getAsset$1$1("world-1", type$.Music));
      J.play$0$x(_this.get$_music());
      J.set$loop$x(_this.get$_music(), true);
      _this._currentScene = B.GameScene_0;
      t1 = A.TitleScene$(_this);
      _this._activeScene = t1;
      t1.enter$0();
    },
    draw$1(ctx) {
      var t1;
      type$.CanvasRenderingContext2D._as(ctx);
      t1 = this._activeScene;
      if (t1 != null)
        t1.draw$1(ctx);
    },
    update$1(dt) {
      ...
      t1 = 1 / dt;
      this._fps = t1;
      this.setWindowTitle$1("fps: " + A.S(B.JSNumber_methods.round$0(t1)));
      t1 = this._activeScene;
      if (t1 != null)
        t1.update$1(dt);
    },
    changeScene$1(newScene) {
      var t1, _this = this;
      type$.GameScene._as(newScene);
      if (A.boolConversionCheck(J.$eq$(_this._currentScene, newScene)))
        return;
      t1 = _this._activeScene;
      if (t1 != null)
        t1.exit$0();
      switch (newScene) {
        case B.GameScene_0:
          _this._activeScene = A.TitleScene$(_this);
          break;
        case B.GameScene_1:
          break;
      }
  ...
  A.HeroB.prototype = {
    update$1(dt) {
      var t1, _this = this;
      A._asDouble(dt);
      t1 = _this._hero$_animTimer;
      if (typeof t1 !== "number")
        return t1.$add();
      t1 += dt;
      _this._hero$_animTimer = t1;
      if (t1 > 0.3) {
        _this._hero$_animTimer = 0;
        t1 = _this._hero$_animFrame;
        if (typeof t1 !== "number")
          return A.iae(t1);
        _this.set$_hero$_animFrame(1 - t1);
      }
    },
    draw$1(ctx) {
      var t1;
      type$.CanvasRenderingContext2D._as(ctx);
      t1 = this.position;
      J.$index$as(this._hero$_frames, this._hero$_animFrame).draw$3(ctx, t1.x, t1.y);
    },
    set$_hero$_animFrame(_animFrame) {
      this._hero$_animFrame = A._asInt(_animFrame);
    }
  };
  ...
  A.Mob.prototype = {
    ...
    get$_speed() {
      return this.__Mob__speed_A;
    },
    get$_mob$_points() {
      return this.__Mob__points_A;
    },
    Mob$6(position, _frames, flipped, _hp, _speed, _points) {
      var _this = this;
      _this.set$_active(true);
      _this.velocity = A.Vector2$(A.boolConversionCheck(_this.flipped) ? J.$negate$in(_this.get$_speed()) : _this.get$_speed(), 0);
    },
    get$points(_) {
      return this.get$_mob$_points();
    },
    update$1(dt) {
      var t1, t2, t3, _this = this;
      A._asDouble(dt);
      if (A.boolConversionCheck(_this.flipped)) {
        t1 = _this.velocity;
        t2 = t1.x;
        if (typeof t2 !== "number")
          return t2.$gt();
        if (t2 > 0) {
          ...
          t1.x = t2;
          if (t2 < 1)
            J.set$x$z(t1, J.$negate$in(_this.get$_speed()));
        }
      } else {
        t1 = _this.velocity;
        t2 = t1.x;
      ...
      if (t3 > 0.25) {
        ...
        if (typeof t2 !== "number")
          return A.iae(t2);
        _this.set$_animFrame(1 - t2);
      }
      t1 = t1.x;
      if (typeof t1 !== "number")
        return t1.$lt();
      if (t1 < -32 || t1 >= 640)
        _this.set$_active(false);
    },
    draw$1(ctx) {
      var t1, _this = this;
      type$.CanvasRenderingContext2D._as(ctx);
      t1 = _this.position;
      J.$index$as(_this._frames, _this._animFrame).draw$4$options(ctx, t1.x, t1.y, A.ImageSliceDrawOptions$(null, _this.flipped, 2));
    },
    set$_animFrame(_animFrame) {
      this._animFrame = A._asInt(_animFrame);
    }
  };
  A.MobBee.prototype = {};
  A.MobBlue.prototype = {};
  A.MobFoxy.prototype = {};
  A.MobSniky.prototype = {};
  A.Powerup.prototype = {
    get$points(_) {
      return this._points;
    },
    draw$1(ctx) {
      ...
      this._image.draw$4$options(type$.CanvasRenderingContext2D._as(ctx), t1.x, t1.y, A.ImageSliceDrawOptions$(100, null, 2));
    }
  };
  A.Medkit.prototype = {};
  A.Bomb.prototype = {};
  A.Sound.prototype = {
    load$0(_) {
      return A.Future_Future(new A.Sound_load_closure(this), type$.void);
    }
  };
  A.Sound_load_closure.prototype = {
    call$0() {
      var request = A.HttpRequest_HttpRequest(),
        t1 = this.$this;
      B.HttpRequest_methods.open$3$async(request, "GET", t1._src, true);
      B.HttpRequest_methods.set$responseType(request, "arraybuffer");
      B.HttpRequest_methods.get$onLoad(request).listen$1(new A.Sound_load__closure(t1, request));
      B.HttpRequest_methods.send$0(request);
    },
    $signature: 1
  };
  A.Sound_load__closure.prototype = {
    call$1($event) {
      type$.ProgressEvent._as($event);
      J.decodeAudioData$2$x($.$get$audioContext(), type$.ByteBuffer._as(J.get$response$x(this.request)), new A.Sound_load___closure(this.$this));
    },
    $signature: 30
  };
  A.Sound_load___closure.prototype = {
    call$1(buffer) {
      type$.AudioBuffer._as(buffer);
    },
    $signature: 7
  };
  A.Music.prototype = {
    Music$1(src) {
      ...
      t2.set$preload(t1, "auto");
      t2.set$src(t1, src);
      t2 = J.get$body$x(A.document());
      if (t2 != null)
        J.append$1$x(t2, t1);
    },
    set$loop(_, val) {
      J.set$loop$x(this._sound, A._asBool(val));
    },
    addEventListener$2(_, type, listener) {
      return J.addEventListener$2$x(this._sound, A._asString(type), type$.nullable_dynamic_Function_Event._as(listener));
    },
    play$0(_) {
      var $async$goto = 0,
      ...
      var $async$play$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$returnValue = J.play$0$x($async$self._sound);
              // goto return
              $async$goto = 1;
              break;
            case 1:
  ...
  A.Drawable.prototype = {$isSprite: 1};
  A.Movable.prototype = {};
  A.TitleScene.prototype = {
    enter$0() {
      return this.noSuchMethod$1(0, A.createUnmangledInvocationMirror(B.Symbol_enter, "enter$0", 0, [], [], 0));
    },
    exit$0() {
      return this.noSuchMethod$1(0, A.createUnmangledInvocationMirror(B.Symbol_exit, "exit$0", 0, [], [], 0));
    },
    get$game() {
      return type$.Game._as(this.noSuchMethod$1(0, A.createUnmangledInvocationMirror(B.Symbol_game, "get$game", 1, [], [], 0)));
    },
    get$_title$_title(_) {
      return this.__TitleScene__title_A;
    },
    set$_title$_title(_, value) {
      this.__TitleScene__title_A = type$.ImageSlice._as(value);
    },
    get$_forest() {
      return this.__TitleScene__forest_A;
    },
    set$_forest(value) {
      this.__TitleScene__forest_A = type$.ImageSlice._as(value);
    },
    get$_text() {
      return this.__TitleScene__text_A;
    },
    set$_text(value) {
      this.__TitleScene__text_A = type$.BitmapText._as(value);
    },
    get$_mobs() {
      return this.__TitleScene__mobs_A;
    },
    set$_mobs(value) {
      this.set$__TitleScene__mobs_A(type$.List_Mob._as(value));
    },
    get$_bomb() {
      return this.__TitleScene__bomb_A;
    },
    set$_bomb(value) {
      this.__TitleScene__bomb_A = type$.Bomb._as(value);
    },
    get$_medkit() {
      return this.__TitleScene__medkit_A;
    },
    set$_medkit(value) {
      this.__TitleScene__medkit_A = type$.Medkit._as(value);
    },
    get$_hero() {
      return this.__TitleScene__hero_A;
    },
    set$_hero(value) {
      this.__TitleScene__hero_A = type$.HeroB._as(value);
    },
    get$_backgroundCache() {
      return this.__TitleScene__backgroundCache_A;
    },
    set$_backgroundCache(value) {
      this.__TitleScene__backgroundCache_A = type$.ImageCache._as(value);
    },
    TitleScene$1(game) {
      var _this = this,
        t1 = type$.ImageElement;
      _this.set$_title$_title(0, A.ImageSlice$(_this.get$game().getAsset$1$1("titleBitmap", t1), 0, 0, 640, 480));
      _this.set$_forest(A.ImageSlice$(_this.get$game().getAsset$1$1("forest", t1), 0, 0, 640, 312));
      _this.set$_text(A.BitmapText$(_this.get$game().getAsset$1$1("bitmapFont", t1)));
      _this.set$_mobs(A._setArrayType([A.MobBee$(_this.get$game(), false, A.Vector2$(80, 140), 0), A.MobBlue$(_this.get$game(), false, A.Vector2$(80, 180), 0), A.MobSniky$(_this.get$game(), false, A.Vector2$(80, 220), 0), A.MobFoxy$(_this.get$game(), false, A.Vector2$(80, 260), 0)], type$.JSArray_Mob));
      _this.set$_bomb(A.Bomb$(game, A.Vector2$(80, 300)));
      _this.set$_medkit(A.Medkit$(game, A.Vector2$(80, 340)));
      _this.set$_hero(A.HeroB$(game, A.Vector2$(40, 40)));
      _this.set$_backgroundCache(A.ImageCache$(game.get$renderer().get$backbuffer()));
    },
    draw$1(ctx) {
      var _this = this;
      type$.CanvasRenderingContext2D._as(ctx);
      _this.get$_backgroundCache().draw$2(ctx, new A.TitleScene_draw_closure(_this, ctx));
      _this.get$_hero().draw$1(ctx);
      J.forEach$1$a(_this.get$_mobs(), new A.TitleScene_draw_closure0(ctx));
    },
    update$1(dt) {
      var _this = this;
      A._asDouble(dt);
      J.forEach$1$a(_this.get$_mobs(), new A.TitleScene_update_closure(dt));
      _this.get$_hero().update$1(dt);
      if (A.boolConversionCheck(_this.get$game().get$input().isPressed$1(B.InputKey_KeyZ_KEY_FIRE)))
        _this.get$game().changeScene$1(B.GameScene_1);
    },
    noSuchMethod$1(_, invocation) {
      return this.super$Object$noSuchMethod(0, type$.Invocation._as(invocation));
    },
    set$__TitleScene__mobs_A(__TitleScene__mobs_A) {
      this.__TitleScene__mobs_A = type$.List_Mob._as(__TitleScene__mobs_A);
    },
    $isBaseScene: 1
  };
  A.TitleScene_draw_closure.prototype = {
    call$0() {
      var t3, _s5_ = "white",
        t1 = this.$this,
        t2 = this.ctx;
      t1.get$_forest().draw$3(t2, 0, 0);
      t3 = J.getInterceptor$x(t2);
      t3.set$fillStyle(t2, "#0c1122");
      t3.fillRect$4(t2, 0, 312, 640, 168);
      J.get$_title$_title$x(t1).draw$3(t2, 0, 0);
      t1.get$_text().draw$5(t2, 120, 150, _s5_, "BEE .......... " + A.S(A.Util_formatNumber(J.get$points$z(J.$index$as(t1.get$_mobs(), 0)), 3)) + " POINTS");
      t1.get$_text().draw$5(t2, 120, 190, _s5_, "BLUE ......... " + A.S(A.Util_formatNumber(J.get$points$z(J.$index$as(t1.get$_mobs(), 1)), 3)) + " POINTS");
      t1.get$_text().draw$5(t2, 120, 230, _s5_, "SNIKY ........ " + A.S(A.Util_formatNumber(J.get$points$z(J.$index$as(t1.get$_mobs(), 2)), 3)) + " POINTS");
      t1.get$_text().draw$5(t2, 120, 270, _s5_, "FOXY ......... " + A.S(A.Util_formatNumber(J.get$points$z(J.$index$as(t1.get$_mobs(), 3)), 3)) + " POINTS");
      t1.get$_text().draw$5(t2, 120, 310, _s5_, "BOMB ......... " + A.S(A.Util_formatNumber(J.get$points$z(t1.get$_bomb()), 3)) + " POINTS");
      t1.get$_text().draw$5(t2, 120, 350, _s5_, "MEDKIT ....... " + A.S(A.Util_formatNumber(J.get$points$z(t1.get$_medkit()), 3)) + " POINTS");
      t1.get$_text().draw$5(t2, 140, 420, _s5_, 'PRESS "FIRE" TO START');
      t1.get$_text().draw$6(t2, 208, 462, "gray", 'PRESS "F11" FOR FULLSCREEN', A.DrawTextOptions$(1));
      t1.get$_bomb().draw$1(t2);
      t1.get$_medkit().draw$1(t2);
    },
    $signature: 0
  };
  A.TitleScene_draw_closure0.prototype = {
    call$1(m) {
      return type$.Mob._as(m).draw$1(this.ctx);
    },
    $signature: 9
  };
  A.TitleScene_update_closure.prototype = {
    call$1(m) {
      return type$.Mob._as(m).update$1(this.dt);
    },
    $signature: 9
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootScheduleMicrotask$closure", 4, null, ["call$4"], ["_rootScheduleMicrotask"], 31, 0);
    _instance_2_u(A._Future.prototype, "get$_completeError", "_completeError$2", 16);
    _instance_1_i(A.Engine.prototype, "get$loop", "loop$1", 27);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.SentinelValue, A.Iterable, A.Symbol, A.MapView, A.ConstantMap, A.JSInvocationMirror, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.Closure, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._StreamIterator, A._ZoneFunction, A._Zone, A._UnmodifiableMapMixin, A.DateTime, A.Duration, A._Enum, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.StringBuffer, A.EventStreamProvider, A._EventStreamSubscription, A._AcceptStructuredClone, A.NullRejectionException, A.Drawable, A.DrawTextOptions, A.BitmapText, A.MediaException, A.Loader, A.Renderer, A.EngineOptions, A.Engine, A.Input, A.Vector2, A.ImageSliceDrawOptions, A.ImageSlice, A.ImageCache, A.Sound, A.Music, A.TitleScene]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSNumber, J.JSString]);
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.NativeByteBuffer, A.EventTarget, A.Event, A.Blob, A.CanvasRenderingContext2D, A.DomError, A.DomException, A.DomRectReadOnly, A.MediaError, A.NavigatorUserMediaError, A.OverconstrainedError, A.PositionError, A.AudioBuffer, A.RenderingContext, A.RenderingContext2]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A._convertDartToNative_Value_closure, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.AudioContext_decodeAudioData_success, A.AudioContext_decodeAudioData_error, A.AudioContext_decodeAudioData_closure, A.AudioContext_decodeAudioData_closure0, A.Loader_load_closure, A.Loader_load_closure0, A.Loader_load_closure1, A.Engine_run_closure, A.Input_closure, A.Input_closure0, A.Input__getKey_closure, A.main_closure, A.main_closure0, A.Sound_load__closure, A.Sound_load___closure, A.TitleScene_draw_closure0, A.TitleScene_update_closure]);
    _inheritMany(A.TearOffClosure, [A.StaticClosure, A.BoundClosure]);
    _inherit(A._AssertionError, A.AssertionError);
    _inherit(A.JsLinkedHashMap, A.MapBase);
    _inherit(A.LinkedHashMapKeyIterable, A.EfficientLengthIterable);
    _inheritMany(A.Closure2Args, [A.initHooks_closure0, A._awaitOnObject_closure0, A._wrapJsFunctionForAsync_closure, A._Future__chainForeignFuture_closure0, A.MapBase_mapToString_closure, A.NoSuchMethodError_toString_closure, A._AcceptStructuredClone_walk_closure, A.convertDartToNative_Dictionary_closure]);
    _inherit(A._TypeError, A._Error);
    _inheritMany(A.Closure0Args, [A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A.Future_Future_closure, A.Future_Future$delayed_closure, A._Future__addListener_closure, A._Future__prependListeners_closure, A._Future__chainForeignFuture_closure1, A._Future__chainCoreFutureAsync_closure, A._Future__asyncCompleteWithValue_closure, A._Future__asyncCompleteError_closure, A._Future__propagateToListeners_handleWhenCompleteCallback, A._Future__propagateToListeners_handleValueCallback, A._Future__propagateToListeners_handleError, A.Stream_length_closure0, A._rootHandleError_closure, A._RootZone_bindCallback_closure, A._RootZone_bindCallbackGuarded_closure, A.Engine_closure, A.Input__getKey_closure0, A.Sound_load_closure, A.TitleScene_draw_closure]);
    _inherit(A._AsyncCompleter, A._Completer);
    _inherit(A._RootZone, A._Zone);
    _inheritMany(A.ArgumentError, [A.RangeError, A.IndexError]);
    _inheritMany(A.EventTarget, [A.Node, A.HttpRequestEventTarget, A.Window, A.BaseAudioContext]);
    ...
    _inherit(A.AudioContext, A.BaseAudioContext);
    _inheritMany(A.Drawable, [A.Movable, A.HeroB]);
    _inherit(A.Actor, A.Movable);
    _inheritMany(A._Enum, [A.InputKey, A.GameScene]);
    _inherit(A.Game, A.Engine);
    _inheritMany(A.Actor, [A.Mob, A.Powerup]);
    _inheritMany(A.Mob, [A.MobBee, A.MobBlue, A.MobFoxy, A.MobSniky]);
    _inheritMany(A.Powerup, [A.Medkit, A.Bomb]);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      BitmapText: findType("BitmapText"),
      Bomb: findType("Bomb"),
      ...
      EventStreamProvider_Event: findType("EventStreamProvider<Event>"),
      Function: findType("Function"),
      Future_dynamic: findType("Future<@>"),
      Game: findType("Game"),
      GameScene: findType("GameScene"),
      HeroB: findType("HeroB"),
      ImageCache: findType("ImageCache"),
      ImageElement: findType("ImageElement"),
      ImageSlice: findType("ImageSlice"),
      InputKey: findType("InputKey"),
      Invocation: findType("Invocation"),
      Iterable_dynamic: findType("Iterable<@>"),
      JSArray_ImageSlice: findType("JSArray<ImageSlice>"),
      JSArray_Mob: findType("JSArray<Mob>"),
      JSArray_String: findType("JSArray<String>"),
      JSArray_dynamic: findType("JSArray<@>"),
      JSNull: findType("JSNull"),
      JavaScriptFunction: findType("JavaScriptFunction"),
      KeyboardEvent: findType("KeyboardEvent"),
      List_Mob: findType("List<Mob>"),
      List_dynamic: findType("List<@>"),
      Map_dynamic_dynamic: findType("Map<@,@>"),
      Medkit: findType("Medkit"),
      Mob: findType("Mob"),
      Music: findType("Music"),
      Node: findType("Node"),
      Null: findType("Null"),
      ...
      nullable_DomException: findType("DomException?"),
      nullable_DrawTextOptions: findType("DrawTextOptions?"),
      nullable_EventTarget: findType("EventTarget?"),
      nullable_Function: findType("Function?"),
      nullable_Future_Null: findType("Future<Null>?"),
      nullable_ImageSliceDrawOptions: findType("ImageSliceDrawOptions?"),
  ...
  (function constants() {
    ...
    B.KeyboardEvent_methods = A.KeyboardEvent.prototype;
    B.PlainJavaScriptObject_methods = J.PlainJavaScriptObject.prototype;
    B.UnknownJavaScriptObject_methods = J.UnknownJavaScriptObject.prototype;
    B._DomRect_methods = A._DomRect.prototype;
...
;
    ...
    B.EventStreamProvider_blur = new A.EventStreamProvider("blur", type$.EventStreamProvider_Event);
    B.EventStreamProvider_focus = new A.EventStreamProvider("focus", type$.EventStreamProvider_Event);
    B.EventStreamProvider_load = new A.EventStreamProvider("load", A.findType("EventStreamProvider<ProgressEvent>"));
    B.GameScene_0 = new A.GameScene("GAME_SCENE_TITLE");
    B.GameScene_1 = new A.GameScene("GAME_SCENE_ACTION");
    B.InputKey_FNF = new A.InputKey("", "NO_KEY");
    B.InputKey_KeyZ_KEY_FIRE = new A.InputKey("KeyZ", "KEY_FIRE");
    B.InputKey_ArrowLeft_KEY_LEFT = new A.InputKey("ArrowLeft", "KEY_LEFT");
    B.InputKey_ArrowDown_KEY_DOWN = new A.InputKey("ArrowDown", "KEY_DOWN");
    B.InputKey_ArrowRight_KEY_RIGHT = new A.InputKey("ArrowRight", "KEY_RIGHT");
    B.InputKey_ArrowUp_KEY_UP = new A.InputKey("ArrowUp", "KEY_UP");
    B.InputKey_Enter_KEY_RETURN = new A.InputKey("Enter", "KEY_RETURN");
    B.InputKey_Escape_KEY_ESCAPE = new A.InputKey("Escape", "KEY_ESCAPE");
    B.InputKey_Backspace_KEY_BS = new A.InputKey("Backspace", "KEY_BS");
    B.InputKey_Space_KEY_SPACE = new A.InputKey("Space", "KEY_SPACE");
    B.InputKey_PageDown_KEY_PGDOWN = new A.InputKey("PageDown", "KEY_PGDOWN");
    B.InputKey_PageUp_KEY_PGUP = new A.InputKey("PageUp", "KEY_PGUP");
    B.InputKey_KeyA_KEY_A = new A.InputKey("KeyA", "KEY_A");
    B.InputKey_KeyB_KEY_B = new A.InputKey("KeyB", "KEY_B");
    B.InputKey_KeyC_KEY_C = new A.InputKey("KeyC", "KEY_C");
    B.InputKey_KeyD_KEY_D = new A.InputKey("KeyD", "KEY_D");
    B.InputKey_KeyE_KEY_E = new A.InputKey("KeyE", "KEY_E");
    B.InputKey_KeyF_KEY_F = new A.InputKey("KeyF", "KEY_F");
    B.InputKey_KeyG_KEY_G = new A.InputKey("KeyG", "KEY_G");
    B.InputKey_KeyH_KEY_H = new A.InputKey("KeyH", "KEY_H");
    B.InputKey_KeyI_KEY_I = new A.InputKey("KeyI", "KEY_I");
    B.InputKey_KeyJ_KEY_J = new A.InputKey("KeyJ", "KEY_J");
    B.InputKey_KeyK_KEY_K = new A.InputKey("KeyK", "KEY_K");
    B.InputKey_KeyL_KEY_L = new A.InputKey("KeyL", "KEY_L");
    B.InputKey_KeyM_KEY_M = new A.InputKey("KeyM", "KEY_M");
    B.InputKey_KeyN_KEY_N = new A.InputKey("KeyN", "KEY_N");
    B.InputKey_KeyO_KEY_O = new A.InputKey("KeyO", "KEY_O");
    B.InputKey_KeyP_KEY_P = new A.InputKey("KeyP", "KEY_P");
    B.InputKey_KeyQ_KEY_Q = new A.InputKey("KeyQ", "KEY_Q");
    B.InputKey_KeyR_KEY_R = new A.InputKey("KeyR", "KEY_R");
    B.InputKey_KeyS_KEY_S = new A.InputKey("KeyS", "KEY_S");
    B.InputKey_KeyT_KEY_T = new A.InputKey("KeyT", "KEY_T");
    B.InputKey_KeyU_KEY_U = new A.InputKey("KeyU", "KEY_U");
    B.InputKey_KeyV_KEY_V = new A.InputKey("KeyV", "KEY_V");
    B.InputKey_KeyW_KEY_W = new A.InputKey("KeyW", "KEY_W");
    B.InputKey_KeyX_KEY_X = new A.InputKey("KeyX", "KEY_X");
    B.InputKey_KeyY_KEY_Y = new A.InputKey("KeyY", "KEY_Y");
    B.InputKey_KeyZ_KEY_Z = new A.InputKey("KeyZ", "KEY_Z");
    B.InputKey_keyF11_KEY_F11 = new A.InputKey("keyF11", "KEY_F11");
    B.List_Rof = A._setArrayType(makeConstList([B.InputKey_FNF, B.InputKey_ArrowLeft_KEY_LEFT, B.InputKey_ArrowDown_KEY_DOWN, B.InputKey_ArrowRight_KEY_RIGHT, B.InputKey_ArrowUp_KEY_UP, B.InputKey_Enter_KEY_RETURN, B.InputKey_Escape_KEY_ESCAPE, B.InputKey_Backspace_KEY_BS, B.InputKey_Space_KEY_SPACE, B.InputKey_PageDown_KEY_PGDOWN, B.InputKey_PageUp_KEY_PGUP, B.InputKey_KeyZ_KEY_FIRE, B.InputKey_KeyA_KEY_A, B.InputKey_KeyB_KEY_B, B.InputKey_KeyC_KEY_C, B.InputKey_KeyD_KEY_D, B.InputKey_KeyE_KEY_E, B.InputKey_KeyF_KEY_F, B.InputKey_KeyG_KEY_G, B.InputKey_KeyH_KEY_H, B.InputKey_KeyI_KEY_I, B.InputKey_KeyJ_KEY_J, B.InputKey_KeyK_KEY_K, B.InputKey_KeyL_KEY_L, B.InputKey_KeyM_KEY_M, B.InputKey_KeyN_KEY_N, B.InputKey_KeyO_KEY_O, B.InputKey_KeyP_KEY_P, B.InputKey_KeyQ_KEY_Q, B.InputKey_KeyR_KEY_R, B.InputKey_KeyS_KEY_S, B.InputKey_KeyT_KEY_T, B.InputKey_KeyU_KEY_U, B.InputKey_KeyV_KEY_V, B.InputKey_KeyW_KEY_W, B.InputKey_KeyX_KEY_X, B.InputKey_KeyY_KEY_Y, B.InputKey_KeyZ_KEY_Z, B.InputKey_keyF11_KEY_F11]), A.findType("JSArray<InputKey>"));
    ...
    B.Symbol_enter = new A.Symbol("enter");
    B.Symbol_exit = new A.Symbol("exit");
    B.Symbol_game = new A.Symbol("game");
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "displaySize", "$get$displaySize", () => A.Vector2$(640, 480));
    _lazyFinal($, "audioContext", "$get$audioContext", () => A.AudioContext_AudioContext());
  })();
  (function nativeSupport() {
    ...
    hunkHelpers.setOrUpdateInterceptorsByTag({ArrayBuffer: A.NativeByteBuffer, HTMLElement: A.HtmlElement, AbortPaymentEvent: A.AbortPaymentEvent, HTMLAnchorElement: A.AnchorElement, AnimationEvent: A.AnimationEvent, AnimationPlaybackEvent: A.AnimationPlaybackEvent, ApplicationCacheErrorEvent: A.ApplicationCacheErrorEvent, HTMLAreaElement: A.AreaElement, HTMLAudioElement: A.AudioElement, HTMLBRElement: A.BRElement, BackgroundFetchClickEvent: A.BackgroundFetchClickEvent, BackgroundFetchEvent: A.BackgroundFetchEvent, BackgroundFetchFailEvent: A.BackgroundFetchFailEvent, BackgroundFetchedEvent: A.BackgroundFetchedEvent, HTMLBaseElement: A.BaseElement, BeforeInstallPromptEvent: A.BeforeInstallPromptEvent, BeforeUnloadEvent: A.BeforeUnloadEvent, Blob: A.Blob, BlobEvent: A.BlobEvent, HTMLBodyElement: A.BodyElement, HTMLButtonElement: A.ButtonElement, CDATASection: A.CDataSection, CanMakePaymentEvent: A.CanMakePaymentEvent, HTMLCanvasElement: A.CanvasElement, CanvasRenderingContext2D: A.CanvasRenderingContext2D, CharacterData: A.CharacterData, ClipboardEvent: A.ClipboardEvent, CloseEvent: A.CloseEvent, Comment: A.Comment, CompositionEvent: A.CompositionEvent, HTMLContentElement: A.ContentElement, CustomEvent: A.CustomEvent, HTMLDListElement: A.DListElement, HTMLDataElement: A.DataElement, HTMLDataListElement: A.DataListElement, HTMLDetailsElement: A.DetailsElement, DeviceMotionEvent: A.DeviceMotionEvent, DeviceOrientationEvent: A.DeviceOrientationEvent, HTMLDialogElement: A.DialogElement, HTMLDivElement: A.DivElement, Document: A.Document, DocumentFragment: A.DocumentFragment, DOMError: A.DomError, DOMException: A.DomException, DOMRectReadOnly: A.DomRectReadOnly, Element: A.Element, HTMLEmbedElement: A.EmbedElement, ErrorEvent: A.ErrorEvent, Event: A.Event, InputEvent: A.Event, SubmitEvent: A.Event, EventTarget: A.EventTarget, ExtendableEvent: A.ExtendableEvent, ExtendableMessageEvent: A.ExtendableMessageEvent, FetchEvent: A.FetchEvent, HTMLFieldSetElement: A.FieldSetElement, File: A.File, FocusEvent: A.FocusEvent, FontFaceSetLoadEvent: A.FontFaceSetLoadEvent, ForeignFetchEvent: A.ForeignFetchEvent, HTMLFormElement: A.FormElement, GamepadEvent: A.GamepadEvent, HTMLHRElement: A.HRElement, HashChangeEvent: A.HashChangeEvent, HTMLHeadElement: A.HeadElement, HTMLHeadingElement: A.HeadingElement, HTMLDocument: A.HtmlDocument, HTMLHtmlElement: A.HtmlHtmlElement, XMLHttpRequest: A.HttpRequest, XMLHttpRequestEventTarget: A.HttpRequestEventTarget, HTMLIFrameElement: A.IFrameElement, HTMLImageElement: A.ImageElement, HTMLInputElement: A.InputElement, InstallEvent: A.InstallEvent, KeyboardEvent: A.KeyboardEvent, HTMLLIElement: A.LIElement, HTMLLabelElement: A.LabelElement, HTMLLegendElement: A.LegendElement, HTMLLinkElement: A.LinkElement, HTMLMapElement: A.MapElement, MathMLElement: A.MathMLElement, HTMLMediaElement: A.MediaElement, MediaEncryptedEvent: A.MediaEncryptedEvent, MediaError: A.MediaError, MediaKeyMessageEvent: A.MediaKeyMessageEvent, MediaQueryListEvent: A.MediaQueryListEvent, MediaStreamEvent: A.MediaStreamEvent, MediaStreamTrackEvent: A.MediaStreamTrackEvent, HTMLMenuElement: A.MenuElement, MessageEvent: A.MessageEvent, HTMLMetaElement: A.MetaElement, HTMLMeterElement: A.MeterElement, MIDIConnectionEvent: A.MidiConnectionEvent, MIDIMessageEvent: A.MidiMessageEvent, HTMLModElement: A.ModElement, MouseEvent: A.MouseEvent, DragEvent: A.MouseEvent, MutationEvent: A.MutationEvent, NavigatorUserMediaError: A.NavigatorUserMediaError, Node: A.Node, NotificationEvent: A.NotificationEvent, HTMLOListElement: A.OListElement, HTMLObjectElement: A.ObjectElement, HTMLOptGroupElement: A.OptGroupElement, HTMLOptionElement: A.OptionElement, HTMLOutputElement: A.OutputElement, OverconstrainedError: A.OverconstrainedError, PageTransitionEvent: A.PageTransitionEvent, HTMLParagraphElement: A.ParagraphElement, HTMLParamElement: A.ParamElement, PaymentRequestEvent: A.PaymentRequestEvent, PaymentRequestUpdateEvent: A.PaymentRequestUpdateEvent, HTMLPictureElement: A.PictureElement, PointerEvent: A.PointerEvent, PopStateEvent: A.PopStateEvent, PositionError: A.PositionError, GeolocationPositionError: A.PositionError, HTMLPreElement: A.PreElement, PresentationConnectionAvailableEvent: A.PresentationConnectionAvailableEvent, PresentationConnectionCloseEvent: A.PresentationConnectionCloseEvent, ProcessingInstruction: A.ProcessingInstruction, HTMLProgressElement: A.ProgressElement, ProgressEvent: A.ProgressEvent, PromiseRejectionEvent: A.PromiseRejectionEvent, PushEvent: A.PushEvent, HTMLQuoteElement: A.QuoteElement, RTCDataChannelEvent: A.RtcDataChannelEvent, RTCDTMFToneChangeEvent: A.RtcDtmfToneChangeEvent, RTCPeerConnectionIceEvent: A.RtcPeerConnectionIceEvent, RTCTrackEvent: A.RtcTrackEvent, HTMLScriptElement: A.ScriptElement, SecurityPolicyViolationEvent: A.SecurityPolicyViolationEvent, HTMLSelectElement: A.SelectElement, SensorErrorEvent: A.SensorErrorEvent, HTMLShadowElement: A.ShadowElement, ShadowRoot: A.ShadowRoot, HTMLSlotElement: A.SlotElement, HTMLSourceElement: A.SourceElement, HTMLSpanElement: A.SpanElement, SpeechRecognitionError: A.SpeechRecognitionError, SpeechRecognitionEvent: A.SpeechRecognitionEvent, SpeechSynthesisEvent: A.SpeechSynthesisEvent, StorageEvent: A.StorageEvent, HTMLStyleElement: A.StyleElement, SyncEvent: A.SyncEvent, HTMLTableCaptionElement: A.TableCaptionElement, HTMLTableCellElement: A.TableCellElement, HTMLTableDataCellElement: A.TableCellElement, HTMLTableHeaderCellElement: A.TableCellElement, HTMLTableColElement: A.TableColElement, HTMLTableElement: A.TableElement, HTMLTableRowElement: A.TableRowElement, HTMLTableSectionElement: A.TableSectionElement, HTMLTemplateElement: A.TemplateElement, Text: A.Text, HTMLTextAreaElement: A.TextAreaElement, TextEvent: A.TextEvent, HTMLTimeElement: A.TimeElement, HTMLTitleElement: A.TitleElement, TouchEvent: A.TouchEvent, HTMLTrackElement: A.TrackElement, TrackEvent: A.TrackEvent, TransitionEvent: A.TransitionEvent, WebKitTransitionEvent: A.TransitionEvent, UIEvent: A.UIEvent, HTMLUListElement: A.UListElement, HTMLUnknownElement: A.UnknownElement, VRDeviceEvent: A.VRDeviceEvent, VRDisplayEvent: A.VRDisplayEvent, VRSessionEvent: A.VRSessionEvent, HTMLVideoElement: A.VideoElement, WheelEvent: A.WheelEvent, Window: A.Window, DOMWindow: A.Window, XMLDocument: A.XmlDocument, Attr: A._Attr, DocumentType: A._DocumentType, ClientRect: A._DomRect, DOMRect: A._DomRect, HTMLDirectoryElement: A._HTMLDirectoryElement, HTMLFontElement: A._HTMLFontElement, HTMLFrameElement: A._HTMLFrameElement, HTMLFrameSetElement: A._HTMLFrameSetElement, HTMLMarqueeElement: A._HTMLMarqueeElement, MojoInterfaceRequestEvent: A._MojoInterfaceRequestEvent, ResourceProgressEvent: A._ResourceProgressEvent, USBConnectionEvent: A._USBConnectionEvent, IDBVersionChangeEvent: A.VersionChangeEvent, SVGAElement: A.AElement, SVGAnimateElement: A.AnimateElement, SVGAnimateMotionElement: A.AnimateMotionElement, SVGAnimateTransformElement: A.AnimateTransformElement, SVGAnimationElement: A.AnimationElement, SVGCircleElement: A.CircleElement, SVGClipPathElement: A.ClipPathElement, SVGDefsElement: A.DefsElement, SVGDescElement: A.DescElement, SVGDiscardElement: A.DiscardElement, SVGEllipseElement: A.EllipseElement, SVGFEBlendElement: A.FEBlendElement, SVGFEColorMatrixElement: A.FEColorMatrixElement, SVGFEComponentTransferElement: A.FEComponentTransferElement, SVGFECompositeElement: A.FECompositeElement, SVGFEConvolveMatrixElement: A.FEConvolveMatrixElement, SVGFEDiffuseLightingElement: A.FEDiffuseLightingElement, SVGFEDisplacementMapElement: A.FEDisplacementMapElement, SVGFEDistantLightElement: A.FEDistantLightElement, SVGFEFloodElement: A.FEFloodElement, SVGFEFuncAElement: A.FEFuncAElement, SVGFEFuncBElement: A.FEFuncBElement, SVGFEFuncGElement: A.FEFuncGElement, SVGFEFuncRElement: A.FEFuncRElement, SVGFEGaussianBlurElement: A.FEGaussianBlurElement, SVGFEImageElement: A.FEImageElement, SVGFEMergeElement: A.FEMergeElement, SVGFEMergeNodeElement: A.FEMergeNodeElement, SVGFEMorphologyElement: A.FEMorphologyElement, SVGFEOffsetElement: A.FEOffsetElement, SVGFEPointLightElement: A.FEPointLightElement, SVGFESpecularLightingElement: A.FESpecularLightingElement, SVGFESpotLightElement: A.FESpotLightElement, SVGFETileElement: A.FETileElement, SVGFETurbulenceElement: A.FETurbulenceElement, SVGFilterElement: A.FilterElement, SVGForeignObjectElement: A.ForeignObjectElement, SVGGElement: A.GElement, SVGGeometryElement: A.GeometryElement, SVGGraphicsElement: A.GraphicsElement, SVGImageElement: A.ImageElement0, SVGLineElement: A.LineElement, SVGLinearGradientElement: A.LinearGradientElement, SVGMarkerElement: A.MarkerElement, SVGMaskElement: A.MaskElement, SVGMetadataElement: A.MetadataElement, SVGPathElement: A.PathElement, SVGPatternElement: A.PatternElement, SVGPolygonElement: A.PolygonElement, SVGPolylineElement: A.PolylineElement, SVGRadialGradientElement: A.RadialGradientElement, SVGRectElement: A.RectElement, SVGScriptElement: A.ScriptElement0, SVGSetElement: A.SetElement, SVGStopElement: A.StopElement, SVGStyleElement: A.StyleElement0, SVGElement: A.SvgElement, SVGSVGElement: A.SvgSvgElement, SVGSwitchElement: A.SwitchElement, SVGSymbolElement: A.SymbolElement, SVGTSpanElement: A.TSpanElement, SVGTextContentElement: A.TextContentElement, SVGTextElement: A.TextElement, SVGTextPathElement: A.TextPathElement, SVGTextPositioningElement: A.TextPositioningElement, SVGTitleElement: A.TitleElement0, SVGUseElement: A.UseElement, SVGViewElement: A.ViewElement, SVGGradientElement: A._GradientElement, SVGComponentTransferFunctionElement: A._SVGComponentTransferFunctionElement, SVGFEDropShadowElement: A._SVGFEDropShadowElement, SVGMPathElement: A._SVGMPathElement, AudioBuffer: A.AudioBuffer, AudioContext: A.AudioContext, webkitAudioContext: A.AudioContext, AudioProcessingEvent: A.AudioProcessingEvent, BaseAudioContext: A.BaseAudioContext, OfflineAudioCompletionEvent: A.OfflineAudioCompletionEvent, WebGLContextEvent: A.ContextEvent, WebGLRenderingContext: A.RenderingContext, WebGL2RenderingContext: A.RenderingContext2});
    hunkHelpers.setOrUpdateLeafTags({ArrayBuffer: true, HTMLElement: false, AbortPaymentEvent: true, HTMLAnchorElement: true, AnimationEvent: true, AnimationPlaybackEvent: true, ApplicationCacheErrorEvent: true, HTMLAreaElement: true, HTMLAudioElement: true, HTMLBRElement: true, BackgroundFetchClickEvent: true, BackgroundFetchEvent: false, BackgroundFetchFailEvent: true, BackgroundFetchedEvent: true, HTMLBaseElement: true, BeforeInstallPromptEvent: true, BeforeUnloadEvent: true, Blob: false, BlobEvent: true, HTMLBodyElement: true, HTMLButtonElement: true, CDATASection: true, CanMakePaymentEvent: true, HTMLCanvasElement: true, CanvasRenderingContext2D: true, CharacterData: false, ClipboardEvent: true, CloseEvent: true, Comment: true, CompositionEvent: true, HTMLContentElement: true, CustomEvent: true, HTMLDListElement: true, HTMLDataElement: true, HTMLDataListElement: true, HTMLDetailsElement: true, DeviceMotionEvent: true, DeviceOrientationEvent: true, HTMLDialogElement: true, HTMLDivElement: true, Document: false, DocumentFragment: false, DOMError: true, DOMException: true, DOMRectReadOnly: false, Element: false, HTMLEmbedElement: true, ErrorEvent: true, Event: false, InputEvent: false, SubmitEvent: false, EventTarget: false, ExtendableEvent: false, ExtendableMessageEvent: true, FetchEvent: true, HTMLFieldSetElement: true, File: true, FocusEvent: true, FontFaceSetLoadEvent: true, ForeignFetchEvent: true, HTMLFormElement: true, GamepadEvent: true, HTMLHRElement: true, HashChangeEvent: true, HTMLHeadElement: true, HTMLHeadingElement: true, HTMLDocument: true, HTMLHtmlElement: true, XMLHttpRequest: true, XMLHttpRequestEventTarget: false, HTMLIFrameElement: true, HTMLImageElement: true, HTMLInputElement: true, InstallEvent: true, KeyboardEvent: true, HTMLLIElement: true, HTMLLabelElement: true, HTMLLegendElement: true, HTMLLinkElement: true, HTMLMapElement: true, MathMLElement: true, HTMLMediaElement: false, MediaEncryptedEvent: true, MediaError: true, MediaKeyMessageEvent: true, MediaQueryListEvent: true, MediaStreamEvent: true, MediaStreamTrackEvent: true, HTMLMenuElement: true, MessageEvent: true, HTMLMetaElement: true, HTMLMeterElement: true, MIDIConnectionEvent: true, MIDIMessageEvent: true, HTMLModElement: true, MouseEvent: false, DragEvent: false, MutationEvent: true, NavigatorUserMediaError: true, Node: false, NotificationEvent: true, HTMLOListElement: true, HTMLObjectElement: true, HTMLOptGroupElement: true, HTMLOptionElement: true, HTMLOutputElement: true, OverconstrainedError: true, PageTransitionEvent: true, HTMLParagraphElement: true, HTMLParamElement: true, PaymentRequestEvent: true, PaymentRequestUpdateEvent: true, HTMLPictureElement: true, PointerEvent: true, PopStateEvent: true, PositionError: true, GeolocationPositionError: true, HTMLPreElement: true, PresentationConnectionAvailableEvent: true, PresentationConnectionCloseEvent: true, ProcessingInstruction: true, HTMLProgressElement: true, ProgressEvent: false, PromiseRejectionEvent: true, PushEvent: true, HTMLQuoteElement: true, RTCDataChannelEvent: true, RTCDTMFToneChangeEvent: true, RTCPeerConnectionIceEvent: true, RTCTrackEvent: true, HTMLScriptElement: true, SecurityPolicyViolationEvent: true, HTMLSelectElement: true, SensorErrorEvent: true, HTMLShadowElement: true, ShadowRoot: true, HTMLSlotElement: true, HTMLSourceElement: true, HTMLSpanElement: true, SpeechRecognitionError: true, SpeechRecognitionEvent: true, SpeechSynthesisEvent: true, StorageEvent: true, HTMLStyleElement: true, SyncEvent: true, HTMLTableCaptionElement: true, HTMLTableCellElement: true, HTMLTableDataCellElement: true, HTMLTableHeaderCellElement: true, HTMLTableColElement: true, HTMLTableElement: true, HTMLTableRowElement: true, HTMLTableSectionElement: true, HTMLTemplateElement: true, Text: false, HTMLTextAreaElement: true, TextEvent: true, HTMLTimeElement: true, HTMLTitleElement: true, TouchEvent: true, HTMLTrackElement: true, TrackEvent: true, TransitionEvent: true, WebKitTransitionEvent: true, UIEvent: false, HTMLUListElement: true, HTMLUnknownElement: true, VRDeviceEvent: true, VRDisplayEvent: true, VRSessionEvent: true, HTMLVideoElement: true, WheelEvent: true, Window: true, DOMWindow: true, XMLDocument: true, Attr: true, DocumentType: true, ClientRect: true, DOMRect: true, HTMLDirectoryElement: true, HTMLFontElement: true, HTMLFrameElement: true, HTMLFrameSetElement: true, HTMLMarqueeElement: true, MojoInterfaceRequestEvent: true, ResourceProgressEvent: true, USBConnectionEvent: true, IDBVersionChangeEvent: true, SVGAElement: true, SVGAnimateElement: true, SVGAnimateMotionElement: true, SVGAnimateTransformElement: true, SVGAnimationElement: false, SVGCircleElement: true, SVGClipPathElement: true, SVGDefsElement: true, SVGDescElement: true, SVGDiscardElement: true, SVGEllipseElement: true, SVGFEBlendElement: true, SVGFEColorMatrixElement: true, SVGFEComponentTransferElement: true, SVGFECompositeElement: true, SVGFEConvolveMatrixElement: true, SVGFEDiffuseLightingElement: true, SVGFEDisplacementMapElement: true, SVGFEDistantLightElement: true, SVGFEFloodElement: true, SVGFEFuncAElement: true, SVGFEFuncBElement: true, SVGFEFuncGElement: true, SVGFEFuncRElement: true, SVGFEGaussianBlurElement: true, SVGFEImageElement: true, SVGFEMergeElement: true, SVGFEMergeNodeElement: true, SVGFEMorphologyElement: true, SVGFEOffsetElement: true, SVGFEPointLightElement: true, SVGFESpecularLightingElement: true, SVGFESpotLightElement: true, SVGFETileElement: true, SVGFETurbulenceElement: true, SVGFilterElement: true, SVGForeignObjectElement: true, SVGGElement: true, SVGGeometryElement: false, SVGGraphicsElement: false, SVGImageElement: true, SVGLineElement: true, SVGLinearGradientElement: true, SVGMarkerElement: true, SVGMaskElement: true, SVGMetadataElement: true, SVGPathElement: true, SVGPatternElement: true, SVGPolygonElement: true, SVGPolylineElement: true, SVGRadialGradientElement: true, SVGRectElement: true, SVGScriptElement: true, SVGSetElement: true, SVGStopElement: true, SVGStyleElement: true, SVGElement: false, SVGSVGElement: true, SVGSwitchElement: true, SVGSymbolElement: true, SVGTSpanElement: true, SVGTextContentElement: false, SVGTextElement: true, SVGTextPathElement: true, SVGTextPositioningElement: false, SVGTitleElement: true, SVGUseElement: true, SVGViewElement: true, SVGGradientElement: false, SVGComponentTransferFunctionElement: false, SVGFEDropShadowElement: true, SVGMPathElement: true, AudioBuffer: true, AudioContext: true, webkitAudioContext: true, AudioProcessingEvent: true, BaseAudioContext: false, OfflineAudioCompletionEvent: true, WebGLContextEvent: true, WebGLRenderingContext: true, WebGL2RenderingContext: true});
  })();
